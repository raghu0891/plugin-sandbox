...
// CLClusterDashboard is a dashboard for a Plugin cluster
...
// NewCLClusterDashboard returns a new dashboard for a Plugin cluster, can be used as a base for more complex plugin based dashboards
