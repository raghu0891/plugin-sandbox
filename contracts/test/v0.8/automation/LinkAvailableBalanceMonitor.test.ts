...
describe('LinkAvailableBalanceMonitor', () => {
  ...
  describe('performUpkeep()', () => {
    ...
    it('should fund the appropriate addresses', async () => {
      ...
      await h.assertLinkTokenBalance(lt, aggregator1.address, zeroPLI)
      await h.assertLinkTokenBalance(lt, aggregator2.address, zeroPLI)
      await h.assertLinkTokenBalance(lt, aggregator3.address, zeroPLI)
      await h.assertLinkTokenBalance(lt, directTarget1.address, zeroPLI)
      await h.assertLinkTokenBalance(lt, directTarget2.address, zeroPLI)
      ...
      await h.assertLinkTokenBalance(lt, aggregator1.address, twoPLI)
      await h.assertLinkTokenBalance(lt, aggregator2.address, twoPLI)
      await h.assertLinkTokenBalance(lt, aggregator3.address, twoPLI)
      await h.assertLinkTokenBalance(lt, directTarget1.address, twoPLI)
      await h.assertLinkTokenBalance(lt, directTarget2.address, twoPLI)
    })
  ...
  describe('topUp()', () => {
    ...
    context('when fully funded', () => {
      ...
      it('should skip un-approved addresses', async () => {
        ...
        await h.assertLinkTokenBalance(lt, aggregator1.address, onePLI)
        await h.assertLinkTokenBalance(lt, aggregator2.address, zeroPLI)
        await h.assertLinkTokenBalance(lt, aggregator3.address, zeroPLI)
        await h.assertLinkTokenBalance(lt, directTarget1.address, onePLI)
        await h.assertLinkTokenBalance(lt, directTarget2.address, zeroPLI)
