...
/**
 * @title The Plugin Mock Oracle contract
 * @notice Plugin smart contract developers can use this to test their contracts
 */
contract MockOracle is PluginRequestInterface, LinkTokenReceiver {
