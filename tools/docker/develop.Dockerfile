...
ENV PLUGIN_DB_NAME plugin_test
ENV PLUGIN_PGPASSWORD=thispasswordislongenough
ENV CL_DATABASE_URL=postgresql://postgres:$PLUGIN_PGPASSWORD@localhost:5432/$PLUGIN_DB_NAME?sslmode=disable
