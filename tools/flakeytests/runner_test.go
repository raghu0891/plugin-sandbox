...
func TestParser(t *testing.T) {
	output := `{"Time":"2023-09-07T15:39:46.378315+01:00","Action":"fail","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Test":"TestLink","Elapsed":0}
`
	...
	ts := pr.tests
	assert.Len(t, ts, 1)
	assert.Len(t, ts["github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets"], 1)
	assert.Equal(t, ts["github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets"]["TestLink"], 1)
}
...
func TestParser_PanicDueToLogging(t *testing.T) {
	output := `
{"Time":"2023-09-07T16:01:40.649849+01:00","Action":"output","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Test":"TestAssets_LinkScanValue","Output":"panic: foo\n"}
`
	...
	assert.Len(t, ts, 1)
	assert.Len(t, ts["github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets"], 1)
	assert.Equal(t, ts["github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets"]["TestAssets_LinkScanValue"], 1)
}

func TestParser_SuccessfulOutput(t *testing.T) {
	output := `
{"Time":"2023-09-07T16:22:52.556853+01:00","Action":"start","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets"}
{"Time":"2023-09-07T16:22:52.762353+01:00","Action":"run","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Test":"TestAssets_NewLinkAndString"}
{"Time":"2023-09-07T16:22:52.762456+01:00","Action":"output","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Test":"TestAssets_NewLinkAndString","Output":"=== RUN   TestAssets_NewLinkAndString\n"}
...
{"Time":"2023-09-07T16:22:52.762528+01:00","Action":"output","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Test":"TestAssets_NewLinkAndString","Output":"=== CONT  TestAssets_NewLinkAndString\n"}
...
{"Time":"2023-09-07T16:22:52.762557+01:00","Action":"pass","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Test":"TestAssets_NewLinkAndString","Elapsed":0}
{"Time":"2023-09-07T16:22:52.762566+01:00","Action":"output","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Output":"PASS\n"}
...
{"Time":"2023-09-07T16:22:52.765598+01:00","Action":"pass","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Elapsed":0.209}
`
...
func TestRunner_WithFlake(t *testing.T) {
	initialOutput := `{"Time":"2023-09-07T15:39:46.378315+01:00","Action":"fail","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Test":"TestLink","Elapsed":0}`
	outputs := []string{
		`{"Time":"2023-09-07T15:39:46.378315+01:00","Action":"fail","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Test":"TestLink","Elapsed":0}`,
		``,
	}
	...
	_, ok := m.report.tests["github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets"]["TestLink"]
	assert.True(t, ok)
}
...
func TestRunner_WithFailedPackage(t *testing.T) {
	initialOutput := `
{"Time":"2023-09-07T15:39:46.378315+01:00","Action":"fail","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Test":"TestLink","Elapsed":0}
{"Time":"2023-09-07T15:39:46.378315+01:00","Action":"fail","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Elapsed":0}
`
	outputs := []string{`
{"Time":"2023-09-07T15:39:46.378315+01:00","Action":"fail","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Test":"TestLink","Elapsed":0}
{"Time":"2023-09-07T15:39:46.378315+01:00","Action":"fail","Package":"github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets","Elapsed":0}
...
func TestIntegration_DealsWithSubtests(t *testing.T) {
	...
	output := `
{"Time":"2023-09-07T15:39:46.378315+01:00","Action":"fail","Package":"github.com/goplugin/pluginv3.0/v2/tools/flakeytests/","Test":"TestSkippedForTests_Subtests/1:_should_fail","Elapsed":0}
{"Time":"2023-09-07T15:39:46.378315+01:00","Action":"fail","Package":"github.com/goplugin/pluginv3.0/v2/tools/flakeytests/","Test":"TestSkippedForTests_Subtests","Elapsed":0}
{"Time":"2023-09-07T15:39:46.378315+01:00","Action":"fail","Package":"github.com/goplugin/pluginv3.0/v2/tools/flakeytests/","Test":"TestSkippedForTests_Subtests/2:_should_fail","Elapsed":0}
`

	m := newMockReporter()
	tc := &testCommand{
		repo:    "github.com/goplugin/pluginv3.0/v2/tools/flakeytests",
	...
	expectedTests := map[string]map[string]int{
		"github.com/goplugin/pluginv3.0/v2/tools/flakeytests/": {
...
func TestIntegration_ParsesPanics(t *testing.T) {
	...
	output := `{"Time":"2023-09-07T15:39:46.378315+01:00","Action":"fail","Package":"github.com/goplugin/pluginv3.0/v2/tools/flakeytests/","Test":"TestSkippedForTests","Elapsed":0}`
	...
	err := r.Run(tests.Context(t))
	require.NoError(t, err)
	_, ok := m.report.tests["github.com/goplugin/pluginv3.0/v2/tools/flakeytests"]["TestSkippedForTests"]
	assert.False(t, ok)
}
...
func TestIntegration(t *testing.T) {
	...
	output := `{"Time":"2023-09-07T15:39:46.378315+01:00","Action":"fail","Package":"github.com/goplugin/pluginv3.0/v2/tools/flakeytests/","Test":"TestSkippedForTests_Success","Elapsed":0}`
	...
	err := r.Run(tests.Context(t))
	require.NoError(t, err)
	_, ok := m.report.tests["github.com/goplugin/pluginv3.0/v2/tools/flakeytests"]["TestSkippedForTests_Success"]
	assert.False(t, ok)
}
