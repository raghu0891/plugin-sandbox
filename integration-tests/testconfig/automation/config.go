...
type General struct {
	...
	PluginNodeLogLevel *string `toml:"plugin_node_log_level"`
...
func (c *General) Validate() error {
	...
	if c.PluginNodeLogLevel == nil {
		return errors.New("plugin_node_log_level must be set")
	}
...
type RegistrySettings struct {
	...
	FlatFeeMicroPLI     *uint32  `toml:"flat_fee_micro_link"`
