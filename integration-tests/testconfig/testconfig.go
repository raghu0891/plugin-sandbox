...
type Common struct {
	PluginNodeFunding *float64 `toml:"plugin_node_funding"`
}

func (c *Common) Validate() error {
	if c.PluginNodeFunding != nil && *c.PluginNodeFunding < 0 {
		return fmt.Errorf("plugin node funding must be positive")
	}
