...
import (
	...
	vrfv2 "github.com/goplugin/pluginv3.0/integration-tests/testconfig/vrfv2"
)
...
type General struct {
	*vrfv2.General
	...
	FulfillmentFlatFeeLinkPPM         *uint32  `toml:"fulfillment_flat_fee_link_ppm"`          // Flat fee in ppm for PLI for the VRF Coordinator config
