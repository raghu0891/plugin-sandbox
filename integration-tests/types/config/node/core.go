...
func NewBaseConfig() *plugin.Config {
	return &plugin.Config{
		Core: toml.Core{
			RootDir: ptr.Ptr("/home/plugin"),
...
type NodeConfigOpt = func(c *plugin.Config)

func NewConfig(baseConf *plugin.Config, opts ...NodeConfigOpt) *plugin.Config {
...
func NewConfigFromToml(tomlConfig []byte, opts ...NodeConfigOpt) (*plugin.Config, error) {
...
func BuildPluginNodeConfig(nets []blockchain.EVMNetwork, nodeConfig, commonChain string, configByChain map[string]string) (*coreplugin.Config, string, error) {
