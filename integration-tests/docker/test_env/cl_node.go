...
type ClNode struct {
	...
	API                   *client.PluginClient `json:"-"`
	NodeConfig            *plugin.Config       `json:"-"`
...
func (n *ClNode) Restart(cfg *plugin.Config) error {
...
func (n *ClNode) GetAPIClient() *client.PluginClient {
	return n.API
}
...
func (n *ClNode) PluginNodeAddress() (common.Address, error) {
