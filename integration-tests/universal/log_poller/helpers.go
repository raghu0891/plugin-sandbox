...
func SetupLogPollerTestDocker(
	...
	*test_env.CLClusterTestEnv,
	...
	env, err = test_env.NewCLTestEnvBuilder().
		...
		WithFunding(big.NewFloat(pluginNodeFunding)).
	...
	// Ethereum Sepolia
	case 11155111:
		linkToken, err = env.ContractLoader.LoadPLIToken("0x779877A7B0D9E8603169DdbD7836e478b4624789")
	// Polygon Mumbai
	case 80001:
		linkToken, err = env.ContractLoader.LoadPLIToken("0x326C977E6efc84E512bB9C30f76E30c160eD06FB")
	default:
		panic("Not implemented")
	}
	require.NoError(t, err, "Error loading/deploying PLI token")
	...
	if minLinkBalance.Cmp(linkBalance) < 0 {
		require.FailNowf(t, "Not enough PLI", "Not enough PLI to run the test. Need at least %s", big.NewInt(0).Div(minLinkBalance, big.NewInt(1e18)).String())
	}
