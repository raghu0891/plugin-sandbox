...
func CreateFundAndGetSendingKeys(
	...
	newNativeTokenKeyAddresses, err := CreateAndFundSendingKeys(client, node, pluginNodeFunding, numberOfTxKeysToCreate, chainID)
	if err != nil {
		return nil, nil, err
	}
...
func CreateAndFundSendingKeys(
	...
	for i := 0; i < numberOfNativeTokenAddressesToCreate; i++ {
		...
		err = actions.FundAddress(client, newTxKey.Data.Attributes.Address, big.NewFloat(pluginNodeFunding))
		if err != nil {
			return nil, err
		}
	}
