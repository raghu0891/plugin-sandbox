...
func CreateVRFV2Job(
	...
	job, err := pluginNode.MustCreateJob(spec)
	if err != nil {
...
func SetupVRFV2Environment(
	...
	vrfTXKeyAddressStrings, vrfTXKeyAddresses, err := vrfcommon.CreateFundAndGetSendingKeys(
		...
		*vrfv2TestConfig.GetCommonConfig().PluginNodeFunding,
...
func SetupVRFV2ForNewEnv(
	...
	mockETHLinkFeed, err := contracts.DeployVRFMockETHPLIFeed(sethClient, big.NewInt(*envConfig.TestConfig.VRFv2.General.LinkNativeFeedResponse))
	if err != nil {
