...
const (
	DefaultConfigFilePath        = "../../../charts/plugin-cluster/connect.toml"
...
// ConnectRemote connects to a local environment, see charts/plugin-cluster
func ConnectRemote(l zerolog.Logger) (blockchain.EVMClient, *client2.MockserverClient, contracts.ContractDeployer, *client.PluginK8sClient, []*client.PluginK8sClient, error) {
	cfg, err := ReadConfig()
	if err != nil {
