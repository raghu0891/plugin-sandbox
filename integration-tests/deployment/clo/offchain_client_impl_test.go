...
[
  {
    "id": "67",
    "name": "Plugin Keystone Node Operator 9",
    "nodes": [
      {
        "id": "780",
        "name": "Plugin Sepolia Prod Keystone One 9",
  ...
  {
    "id": "68",
    "name": "Plugin Keystone Node Operator 8",
    "nodes": [
      {
        "id": "781",
        "name": "Plugin Sepolia Prod Keystone One 8",
  ...
  {
    "id": "999",
    "name": "Plugin Keystone Node Operator 100",
    "nodes": [
      {
        "id": "999",
        "name": "Plugin Sepolia Prod Keystone One 999",
      ...
      {
        "id": "1000",
        "name": "Plugin Sepolia Prod Keystone One 1000",
