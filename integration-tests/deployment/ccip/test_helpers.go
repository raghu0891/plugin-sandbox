...
import (
	...
	"github.com/goplugin/pluginv3.0/integration-tests/deployment/devenv"
...
func (d DeployedLocalDevEnvironment) RestartPluginNodes(t *testing.T) error {
...
func NewLocalDevEnvironment(t *testing.T, lggr logger.Logger) (DeployedEnv, *test_env.CLClusterTestEnv, testconfig.TestConfig) {
	...
	// we cannot create the plugin nodes yet as we need to deploy the capability registry first
	...
	// start the plugin nodes with the CR address
	err = devenv.StartPluginNodes(t, envConfig,
		crConfig,
		testEnv, cfg)
	require.NoError(t, err)
...
const (
	...
	// nolint:lll
	// https://github.com/goplugin/pluginv3.0/blob/a348b98e90527520049c580000a86fb8ceff7fa7/contracts/src/v0.8/tests/MockV3Aggregator.sol#L76-L76
	...
	// nolint:lll
	// https://github.com/goplugin/pluginv3.0/blob/a348b98e90527520049c580000a86fb8ceff7fa7/contracts/src/v0.8/automation/testhelpers/MockETHUSDAggregator.sol#L19-L19
