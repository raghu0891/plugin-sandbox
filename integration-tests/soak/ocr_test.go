...
// TestOCRSoak_RPCDownForAllCLNodes simulates a network chaos by bringing down network to RPC node for all Plugin Nodes
func TestOCRSoak_RPCDownForAllCLNodes(t *testing.T) {
	...
	chaos, err := gethNetworkDownChaos(GethNetworkDownChaosOpts{
		...
		Description: "Geth Network Down For All Plugin Nodes",
		Namespace:   namespace,
		TargetSelector: v1alpha1.PodSelector{
			Selector: v1alpha1.PodSelectorSpec{
				GenericSelectorSpec: v1alpha1.GenericSelectorSpec{
					Namespaces:     []string{namespace},
					LabelSelectors: map[string]string{"app": "plugin-0"},
				},
			},
...
// TestOCRSoak_RPCDownForAllCLNodes simulates a network chaos by bringing down network to RPC node for 50% of Plugin Nodes
func TestOCRSoak_RPCDownForHalfCLNodes(t *testing.T) {
	...
	chaos, err := gethNetworkDownChaos(GethNetworkDownChaosOpts{
		...
		Description: "Geth Network Down For 50 Percent Of Plugin Nodes",
		Namespace:   namespace,
		TargetSelector: v1alpha1.PodSelector{
			Selector: v1alpha1.PodSelectorSpec{
				GenericSelectorSpec: v1alpha1.GenericSelectorSpec{
