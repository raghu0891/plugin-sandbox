...
import (
	...
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_coordinator_test_v2_5"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_coordinator_v2_5"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_coordinator_v2_5_arbitrum"
	...
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_v2plus_upgraded_version"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrfv2plus_wrapper"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrfv2plus_wrapper_arbitrum"
...
func (v *EthereumVRFCoordinatorV2_5) GetLinkAddress(ctx context.Context) (common.Address, error) {
	...
	address, err := v.coordinator.PLI(opts)
	if err != nil {
		return common.Address{}, err
	}
	return address, nil
...
func (v *EthereumVRFCoordinatorV2_5) GetLinkNativeFeed(ctx context.Context) (common.Address, error) {
	...
	address, err := v.coordinator.PLINATIVEFEED(opts)
	if err != nil {
		return common.Address{}, err
	}
	return address, nil
...
func (v *EthereumVRFCoordinatorV2_5) SetPLIAndPLINativeFeed(linkAddress string, linkNativeFeedAddress string) error {
	_, err := v.client.Decode(v.coordinator.SetPLIAndPLINativeFeed(
		v.client.NewTXOpts(),
...
func (v *EthereumVRFCoordinatorV2PlusUpgradedVersion) SetPLIAndPLINativeFeed(linkAddress string, linkNativeFeedAddress string) error {
	_, err := v.client.Decode(v.coordinator.SetPLIAndPLINativeFeed(
		v.client.NewTXOpts(),
		common.HexToAddress(linkAddress),
		common.HexToAddress(linkNativeFeedAddress),
