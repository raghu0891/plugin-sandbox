...
import (
	...
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_coordinator_v2_5"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_v2plus_load_test_with_metrics"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrfv2plus_wrapper"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrfv2plus_wrapper_load_test_consumer"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrfv2plus_wrapper_optimism"
	...
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/solidity_vrf_coordinator_interface"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/solidity_vrf_wrapper"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_coordinator_test_v2"
...
type EthereumVRFMockETHPLIAggregator struct {
	client   *seth.Client
	address  *common.Address
	contract *vrf_mock_ethlink_aggregator.VRFMockETHPLIAggregator
}
...
func (a *EthereumVRFMockETHPLIAggregator) Address() string {
	return a.address.Hex()
}

func (a *EthereumVRFMockETHPLIAggregator) LatestRoundData() (*big.Int, error) {
...
func (a *EthereumVRFMockETHPLIAggregator) LatestRoundDataUpdatedAt() (*big.Int, error) {
	data, err := a.contract.LatestRoundData(a.client.NewCallOpts())
	if err != nil {
		return nil, err
	}
...
func (a *EthereumVRFMockETHPLIAggregator) SetBlockTimestampDeduction(blockTimestampDeduction *big.Int) error {
...
func DeployVRFMockETHPLIFeed(seth *seth.Client, answer *big.Int) (VRFMockETHPLIFeed, error) {
	abi, err := vrf_mock_ethlink_aggregator.VRFMockETHPLIAggregatorMetaData.GetAbi()
	if err != nil {
		return &EthereumVRFMockETHPLIAggregator{}, fmt.Errorf("failed to get VRFMockETHPLIAggregator ABI: %w", err)
	}

	deployment, err := seth.DeployContract(
		seth.NewTXOpts(),
		"VRFMockETHPLIAggregator",
		*abi,
		common.FromHex(vrf_mock_ethlink_aggregator.VRFMockETHPLIAggregatorMetaData.Bin),
		answer,
	)
	if err != nil {
		return &EthereumVRFMockETHPLIAggregator{}, fmt.Errorf("VRFMockETHPLIAggregator deployment have failed: %w", err)
	}

	contract, err := vrf_mock_ethlink_aggregator.NewVRFMockETHPLIAggregator(deployment.Address, wrappers.MustNewWrappedContractBackend(nil, seth))
	if err != nil {
		return &EthereumVRFMockETHPLIAggregator{}, fmt.Errorf("failed to instantiate VRFMockETHPLIAggregator instance: %w", err)
	}

	return &EthereumVRFMockETHPLIAggregator{
		client:   seth,
		contract: contract,
...
func LoadVRFMockETHPLIFeed(client *seth.Client, address common.Address) (VRFMockETHPLIFeed, error) {
	abi, err := mock_ethlink_aggregator_wrapper.MockETHPLIAggregatorMetaData.GetAbi()
	if err != nil {
		return &EthereumVRFMockETHPLIFeed{}, fmt.Errorf("failed to get VRFMockETHPLIAggregator ABI: %w", err)
	}
	client.ContractStore.AddABI("VRFMockETHPLIAggregator", *abi)
	client.ContractStore.AddBIN("VRFMockETHPLIAggregator", common.FromHex(mock_ethlink_aggregator_wrapper.MockETHPLIAggregatorMetaData.Bin))

	instance, err := vrf_mock_ethlink_aggregator.NewVRFMockETHPLIAggregator(address, wrappers.MustNewWrappedContractBackend(nil, client))
	if err != nil {
		return &EthereumVRFMockETHPLIFeed{}, fmt.Errorf("failed to instantiate VRFMockETHPLIAggregator instance: %w", err)
	}
