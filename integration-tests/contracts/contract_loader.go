...
type ContractLoader interface {
	LoadPLIToken(address string) (LinkToken, error)
...
// LoadPLIToken returns deployed on given address PLI Token contract instance
func (e *EthereumContractLoader) LoadPLIToken(addr string) (LinkToken, error) {
	instance, err := e.client.LoadContract("PLI Token", common.HexToAddress(addr), func(
