...
import (
	...
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_load_test_with_metrics"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrfv2_wrapper"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrfv2_wrapper_load_test_consumer"

	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_v2_consumer_wrapper"
)
...
type EthereumVRFMockETHPLIFeed struct {
	client  *seth.Client
	feed    *vrf_mock_ethlink_aggregator.VRFMockETHPLIAggregator
	address common.Address
}
...
func (v *EthereumVRFCoordinatorV2) GetLinkNativeFeed(ctx context.Context) (common.Address, error) {
	...
	address, err := v.coordinator.PLIETHFEED(opts)
	if err != nil {
		return common.Address{}, err
	}
	return address, nil
...
func (v *EthereumVRFMockETHPLIFeed) Address() string {
	return v.address.Hex()
}

func (v *EthereumVRFMockETHPLIFeed) LatestRoundData() (*big.Int, error) {
...
func (v *EthereumVRFMockETHPLIFeed) LatestRoundDataUpdatedAt() (*big.Int, error) {
	data, err := v.feed.LatestRoundData(&bind.CallOpts{
		From:    v.client.MustGetRootKeyAddress(),
		Context: context.Background(),
	})
...
func (v *EthereumVRFMockETHPLIFeed) SetBlockTimestampDeduction(blockTimestampDeduction *big.Int) error {
