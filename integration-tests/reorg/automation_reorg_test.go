...
import (
	...
	sethUtils "github.com/goplugin/plugin-testing-framework/lib/utils/seth"
...
func TestAutomationReorg(t *testing.T) {
	...
	registryVersions := map[string]ethereum.KeeperRegistryVersion{
		...
		"registry_2_2_conditional": ethereum.RegistryVersion_2_2, // Works only on Plugin Node v2.10.0 or greater
		"registry_2_2_logtrigger":  ethereum.RegistryVersion_2_2, // Works only on Plugin Node v2.10.0 or greater
	...
	for n, rv := range registryVersions {
		...
		t.Run(name, func(t *testing.T) {
			...
			err = actions.FundPluginNodesFromRootAddress(l, sethClient, contracts.PluginClientToPluginNodeWithKeysAndAddress(env.ClCluster.NodeAPIs()), big.NewFloat(*config.GetCommonConfig().PluginNodeFunding))
