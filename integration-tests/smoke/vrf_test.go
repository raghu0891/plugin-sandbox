...
import (
	...
	"github.com/goplugin/pluginv3.0/integration-tests/actions/vrf/vrfv1"
	"github.com/goplugin/pluginv3.0/integration-tests/client"
	"github.com/goplugin/pluginv3.0/integration-tests/contracts"
	ethcontracts "github.com/goplugin/pluginv3.0/integration-tests/contracts"
...
func TestVRFBasic(t *testing.T) {
	...
	for _, n := range env.ClCluster.Nodes {
		...
		require.NoError(t, err, "Getting primary ETH address of plugin node shouldn't fail")
		...
		gom.Eventually(func(g gomega.Gomega) {
			...
			// https://bl.chain.link/plugin-vrf-on-chain-verifiable-randomness/
