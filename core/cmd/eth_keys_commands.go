...
func initEthKeysSubCmd(s *Shell) cli.Command {
	return cli.Command{
		...
		Subcommands: cli.Commands{
			...
			{
				Name:   "list",
				Usage:  "List available Ethereum accounts with their ETH & PLI balances and other metadata",
...
var ethKeysTableHeaders = []string{"Address", "EVM Chain ID", "ETH", "PLI", "Disabled", "Created", "Updated", "Max Gas Price Wei"}
...
// ListETHKeys renders the active account address with its ETH & PLI balance
