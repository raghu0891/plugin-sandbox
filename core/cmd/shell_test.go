...
import (
	...
	"github.com/goplugin/pluginv3.0/v2/core/services/keystore/mocks"
...
func TestSetupSolanaRelayer(t *testing.T) {
	...
	nEnabledChains := 2
	tConfig := configtest.NewGeneralConfig(t, func(c *plugin.Config, s *plugin.Secrets) {
	...
	t2Config := configtest.NewGeneralConfig(t, func(c *plugin.Config, s *plugin.Secrets) {
		c.Solana = solcfg.TOMLConfigs{
			&solcfg.TOMLConfig{
				ChainID: ptr[string]("solana-id-1"),
				Enabled: ptr(true),
	...
	duplicateConfig := configtest.NewGeneralConfig(t, func(c *plugin.Config, s *plugin.Secrets) {
		c.Solana = solcfg.TOMLConfigs{
			&solcfg.TOMLConfig{
