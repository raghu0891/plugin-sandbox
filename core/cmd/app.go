...
func NewApp(s *Shell) *cli.App {
	...
	// TOML
	var opts plugin.GeneralConfigOpts
	...
	app.Before = func(c *cli.Context) error {
		...
		if err != nil {
			return fmt.Errorf("error initialize plugin cookie cache: %w", err)
		}
...
func initServerConfig(opts *plugin.GeneralConfigOpts, configFiles []string, secretsFiles []string) (plugin.GeneralConfig, error) {
