...
func setupKeystore(cli *Shell, app plugin.Application, keyStore keystore.Master) error {
...
func createBootstrapperJob(ctx context.Context, lggr logger.Logger, c *cli.Context, app plugin.Application) error {
...
func createDKGJob(ctx context.Context, lggr logger.Logger, app plugin.Application, args dkgTemplateArgs) error {
...
func createOCR2VRFJob(ctx context.Context, lggr logger.Logger, app plugin.Application, args ocr2vrfTemplateArgs) error {
