...
import (
	...
	audit "github.com/goplugin/pluginv3.0/v2/core/logger/audit"

	bridges "github.com/goplugin/pluginv3.0/v2/core/bridges"

	plugin "github.com/goplugin/pluginv3.0/v2/core/services/plugin"

	context "context"

	feeds "github.com/goplugin/pluginv3.0/v2/core/services/feeds"

	job "github.com/goplugin/pluginv3.0/v2/core/services/job"

	jsonserializable "github.com/goplugin/plugin-common/pkg/utils/jsonserializable"

	keystore "github.com/goplugin/pluginv3.0/v2/core/services/keystore"

	logger "github.com/goplugin/pluginv3.0/v2/core/logger"

	logpoller "github.com/goplugin/pluginv3.0/v2/core/chains/evm/logpoller"

	mock "github.com/stretchr/testify/mock"

	pipeline "github.com/goplugin/pluginv3.0/v2/core/services/pipeline"

	plugins "github.com/goplugin/pluginv3.0/v2/plugins"

	services "github.com/goplugin/pluginv3.0/v2/core/services"

	sessions "github.com/goplugin/pluginv3.0/v2/core/sessions"

	sqlutil "github.com/goplugin/plugin-common/pkg/sqlutil"

	txmgr "github.com/goplugin/pluginv3.0/v2/core/chains/evm/txmgr"

	types "github.com/goplugin/pluginv3.0/v2/core/chains/evm/types"

	uuid "github.com/google/uuid"

	webhook "github.com/goplugin/pluginv3.0/v2/core/services/webhook"
...
func (_m *Application) GetConfig() plugin.GeneralConfig {
	ret := _m.Called()
	...
	var r0 plugin.GeneralConfig
	if rf, ok := ret.Get(0).(func() plugin.GeneralConfig); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(plugin.GeneralConfig)
		}
	}
...
func (_c *Application_GetConfig_Call) Return(_a0 plugin.GeneralConfig) *Application_GetConfig_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Application_GetConfig_Call) RunAndReturn(run func() plugin.GeneralConfig) *Application_GetConfig_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Application) GetRelayers() plugin.RelayerChainInteroperators {
	ret := _m.Called()
	...
	var r0 plugin.RelayerChainInteroperators
	if rf, ok := ret.Get(0).(func() plugin.RelayerChainInteroperators); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(plugin.RelayerChainInteroperators)
		}
	}
...
func (_c *Application_GetRelayers_Call) Return(_a0 plugin.RelayerChainInteroperators) *Application_GetRelayers_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Application_GetRelayers_Call) RunAndReturn(run func() plugin.RelayerChainInteroperators) *Application_GetRelayers_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Application) SecretGenerator() plugin.SecretGenerator {
	ret := _m.Called()
	...
	var r0 plugin.SecretGenerator
	if rf, ok := ret.Get(0).(func() plugin.SecretGenerator); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(plugin.SecretGenerator)
		}
	}
...
func (_c *Application_SecretGenerator_Call) Return(_a0 plugin.SecretGenerator) *Application_SecretGenerator_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Application_SecretGenerator_Call) RunAndReturn(run func() plugin.SecretGenerator) *Application_SecretGenerator_Call {
	_c.Call.Return(run)
	return _c
}
