...
func (_KeeperRegistry *KeeperRegistryCaller) PLI(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _KeeperRegistry.contract.Call(opts, &out, "PLI")
...
func (_KeeperRegistry *KeeperRegistrySession) PLI() (common.Address, error) {
	return _KeeperRegistry.Contract.PLI(&_KeeperRegistry.CallOpts)
}

func (_KeeperRegistry *KeeperRegistryCallerSession) PLI() (common.Address, error) {
	return _KeeperRegistry.Contract.PLI(&_KeeperRegistry.CallOpts)
}

func (_KeeperRegistry *KeeperRegistryCaller) PLIETHFEED(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _KeeperRegistry.contract.Call(opts, &out, "PLI_ETH_FEED")
...
func (_KeeperRegistry *KeeperRegistrySession) PLIETHFEED() (common.Address, error) {
	return _KeeperRegistry.Contract.PLIETHFEED(&_KeeperRegistry.CallOpts)
}

func (_KeeperRegistry *KeeperRegistryCallerSession) PLIETHFEED() (common.Address, error) {
	return _KeeperRegistry.Contract.PLIETHFEED(&_KeeperRegistry.CallOpts)
}
