...
func (_IVRFCoordinatorV2PlusInternal *IVRFCoordinatorV2PlusInternalCaller) PLINATIVEFEED(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _IVRFCoordinatorV2PlusInternal.contract.Call(opts, &out, "PLI_NATIVE_FEED")
...
func (_IVRFCoordinatorV2PlusInternal *IVRFCoordinatorV2PlusInternalSession) PLINATIVEFEED() (common.Address, error) {
	return _IVRFCoordinatorV2PlusInternal.Contract.PLINATIVEFEED(&_IVRFCoordinatorV2PlusInternal.CallOpts)
}

func (_IVRFCoordinatorV2PlusInternal *IVRFCoordinatorV2PlusInternalCallerSession) PLINATIVEFEED() (common.Address, error) {
	return _IVRFCoordinatorV2PlusInternal.Contract.PLINATIVEFEED(&_IVRFCoordinatorV2PlusInternal.CallOpts)
}
