...
func (_VRFConsumerV2PlusUpgradeableExample *VRFConsumerV2PlusUpgradeableExampleCaller) PLITOKEN(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFConsumerV2PlusUpgradeableExample.contract.Call(opts, &out, "PLITOKEN")
...
func (_VRFConsumerV2PlusUpgradeableExample *VRFConsumerV2PlusUpgradeableExampleSession) PLITOKEN() (common.Address, error) {
	return _VRFConsumerV2PlusUpgradeableExample.Contract.PLITOKEN(&_VRFConsumerV2PlusUpgradeableExample.CallOpts)
}

func (_VRFConsumerV2PlusUpgradeableExample *VRFConsumerV2PlusUpgradeableExampleCallerSession) PLITOKEN() (common.Address, error) {
	return _VRFConsumerV2PlusUpgradeableExample.Contract.PLITOKEN(&_VRFConsumerV2PlusUpgradeableExample.CallOpts)
}
...
type VRFConsumerV2PlusUpgradeableExampleInterface interface {
	...
	PLITOKEN(opts *bind.CallOpts) (common.Address, error)
