...
func (_VRFConsumerV2UpgradeableExample *VRFConsumerV2UpgradeableExampleCaller) PLITOKEN(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFConsumerV2UpgradeableExample.contract.Call(opts, &out, "PLITOKEN")
...
func (_VRFConsumerV2UpgradeableExample *VRFConsumerV2UpgradeableExampleSession) PLITOKEN() (common.Address, error) {
	return _VRFConsumerV2UpgradeableExample.Contract.PLITOKEN(&_VRFConsumerV2UpgradeableExample.CallOpts)
}

func (_VRFConsumerV2UpgradeableExample *VRFConsumerV2UpgradeableExampleCallerSession) PLITOKEN() (common.Address, error) {
	return _VRFConsumerV2UpgradeableExample.Contract.PLITOKEN(&_VRFConsumerV2UpgradeableExample.CallOpts)
}
