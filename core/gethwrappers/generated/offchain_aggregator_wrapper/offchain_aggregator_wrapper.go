...
func (_OffchainAggregator *OffchainAggregatorCaller) PLI(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _OffchainAggregator.contract.Call(opts, &out, "PLI")
...
func (_OffchainAggregator *OffchainAggregatorSession) PLI() (common.Address, error) {
	return _OffchainAggregator.Contract.PLI(&_OffchainAggregator.CallOpts)
}

func (_OffchainAggregator *OffchainAggregatorCallerSession) PLI() (common.Address, error) {
	return _OffchainAggregator.Contract.PLI(&_OffchainAggregator.CallOpts)
}
