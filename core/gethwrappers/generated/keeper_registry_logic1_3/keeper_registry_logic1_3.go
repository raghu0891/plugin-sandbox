...
func (_KeeperRegistryLogic *KeeperRegistryLogicCaller) PLI(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _KeeperRegistryLogic.contract.Call(opts, &out, "PLI")
...
func (_KeeperRegistryLogic *KeeperRegistryLogicSession) PLI() (common.Address, error) {
	return _KeeperRegistryLogic.Contract.PLI(&_KeeperRegistryLogic.CallOpts)
}

func (_KeeperRegistryLogic *KeeperRegistryLogicCallerSession) PLI() (common.Address, error) {
	return _KeeperRegistryLogic.Contract.PLI(&_KeeperRegistryLogic.CallOpts)
}

func (_KeeperRegistryLogic *KeeperRegistryLogicCaller) PLIETHFEED(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _KeeperRegistryLogic.contract.Call(opts, &out, "PLI_ETH_FEED")
...
func (_KeeperRegistryLogic *KeeperRegistryLogicSession) PLIETHFEED() (common.Address, error) {
	return _KeeperRegistryLogic.Contract.PLIETHFEED(&_KeeperRegistryLogic.CallOpts)
}

func (_KeeperRegistryLogic *KeeperRegistryLogicCallerSession) PLIETHFEED() (common.Address, error) {
	return _KeeperRegistryLogic.Contract.PLIETHFEED(&_KeeperRegistryLogic.CallOpts)
}
