...
func DeployKeeperRegistrar(auth *bind.TransactOpts, backend bind.ContractBackend, PLIAddress common.Address, autoApproveConfigType uint8, autoApproveMaxAllowed uint16, keeperRegistry common.Address, minPLIJuels *big.Int) (common.Address, *types.Transaction, *KeeperRegistrar, error) {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(KeeperRegistrarBin), backend, PLIAddress, autoApproveConfigType, autoApproveMaxAllowed, keeperRegistry, minPLIJuels)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
func (_KeeperRegistrar *KeeperRegistrarCaller) PLI(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _KeeperRegistrar.contract.Call(opts, &out, "PLI")
...
func (_KeeperRegistrar *KeeperRegistrarSession) PLI() (common.Address, error) {
	return _KeeperRegistrar.Contract.PLI(&_KeeperRegistrar.CallOpts)
}

func (_KeeperRegistrar *KeeperRegistrarCallerSession) PLI() (common.Address, error) {
	return _KeeperRegistrar.Contract.PLI(&_KeeperRegistrar.CallOpts)
}
...
func (_KeeperRegistrar *KeeperRegistrarTransactor) SetRegistrationConfig(opts *bind.TransactOpts, autoApproveConfigType uint8, autoApproveMaxAllowed uint16, keeperRegistry common.Address, minPLIJuels *big.Int) (*types.Transaction, error) {
	return _KeeperRegistrar.contract.Transact(opts, "setRegistrationConfig", autoApproveConfigType, autoApproveMaxAllowed, keeperRegistry, minPLIJuels)
}

func (_KeeperRegistrar *KeeperRegistrarSession) SetRegistrationConfig(autoApproveConfigType uint8, autoApproveMaxAllowed uint16, keeperRegistry common.Address, minPLIJuels *big.Int) (*types.Transaction, error) {
	return _KeeperRegistrar.Contract.SetRegistrationConfig(&_KeeperRegistrar.TransactOpts, autoApproveConfigType, autoApproveMaxAllowed, keeperRegistry, minPLIJuels)
}

func (_KeeperRegistrar *KeeperRegistrarTransactorSession) SetRegistrationConfig(autoApproveConfigType uint8, autoApproveMaxAllowed uint16, keeperRegistry common.Address, minPLIJuels *big.Int) (*types.Transaction, error) {
	return _KeeperRegistrar.Contract.SetRegistrationConfig(&_KeeperRegistrar.TransactOpts, autoApproveConfigType, autoApproveMaxAllowed, keeperRegistry, minPLIJuels)
}
...
type KeeperRegistrarInterface interface {
	...
	SetRegistrationConfig(opts *bind.TransactOpts, autoApproveConfigType uint8, autoApproveMaxAllowed uint16, keeperRegistry common.Address, minPLIJuels *big.Int) (*types.Transaction, error)
