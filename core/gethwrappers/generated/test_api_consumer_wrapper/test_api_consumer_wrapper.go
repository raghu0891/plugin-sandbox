...
func (_TestAPIConsumer *TestAPIConsumerCaller) GetPluginToken(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TestAPIConsumer.contract.Call(opts, &out, "getPluginToken")
...
func (_TestAPIConsumer *TestAPIConsumerSession) GetPluginToken() (common.Address, error) {
	return _TestAPIConsumer.Contract.GetPluginToken(&_TestAPIConsumer.CallOpts)
}
...
type TestAPIConsumerPluginCancelledIterator struct {
	Event *TestAPIConsumerPluginCancelled
...
func (it *TestAPIConsumerPluginCancelledIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TestAPIConsumerPluginCancelled)
...
type TestAPIConsumerPluginCancelled struct {
	Id  [32]byte
	Raw types.Log
}
...
func (_TestAPIConsumer *TestAPIConsumerFilterer) FilterPluginCancelled(opts *bind.FilterOpts, id [][32]byte) (*TestAPIConsumerPluginCancelledIterator, error) {
	...
	logs, sub, err := _TestAPIConsumer.contract.FilterLogs(opts, "PluginCancelled", idRule)
	if err != nil {
		return nil, err
	}
	return &TestAPIConsumerPluginCancelledIterator{contract: _TestAPIConsumer.contract, event: "PluginCancelled", logs: logs, sub: sub}, nil
}
...
func (_TestAPIConsumer *TestAPIConsumerFilterer) WatchPluginCancelled(opts *bind.WatchOpts, sink chan<- *TestAPIConsumerPluginCancelled, id [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _TestAPIConsumer.contract.WatchLogs(opts, "PluginCancelled", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TestAPIConsumerPluginCancelled)
				if err := _TestAPIConsumer.contract.UnpackLog(event, "PluginCancelled", log); err != nil {
					return err
				}
				event.Raw = log
...
type TestAPIConsumerPluginFulfilledIterator struct {
	Event *TestAPIConsumerPluginFulfilled
...
func (it *TestAPIConsumerPluginFulfilledIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TestAPIConsumerPluginFulfilled)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type TestAPIConsumerPluginFulfilled struct {
	Id  [32]byte
	Raw types.Log
}
...
func (_TestAPIConsumer *TestAPIConsumerFilterer) FilterPluginFulfilled(opts *bind.FilterOpts, id [][32]byte) (*TestAPIConsumerPluginFulfilledIterator, error) {
	...
	logs, sub, err := _TestAPIConsumer.contract.FilterLogs(opts, "PluginFulfilled", idRule)
	if err != nil {
		return nil, err
	}
	return &TestAPIConsumerPluginFulfilledIterator{contract: _TestAPIConsumer.contract, event: "PluginFulfilled", logs: logs, sub: sub}, nil
}
...
func (_TestAPIConsumer *TestAPIConsumerFilterer) WatchPluginFulfilled(opts *bind.WatchOpts, sink chan<- *TestAPIConsumerPluginFulfilled, id [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _TestAPIConsumer.contract.WatchLogs(opts, "PluginFulfilled", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TestAPIConsumerPluginFulfilled)
				if err := _TestAPIConsumer.contract.UnpackLog(event, "PluginFulfilled", log); err != nil {
					return err
				}
				event.Raw = log
...
type TestAPIConsumerPluginRequestedIterator struct {
	Event *TestAPIConsumerPluginRequested
...
func (it *TestAPIConsumerPluginRequestedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TestAPIConsumerPluginRequested)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type TestAPIConsumerPluginRequested struct {
	Id  [32]byte
	Raw types.Log
}
...
func (_TestAPIConsumer *TestAPIConsumerFilterer) FilterPluginRequested(opts *bind.FilterOpts, id [][32]byte) (*TestAPIConsumerPluginRequestedIterator, error) {
	...
	logs, sub, err := _TestAPIConsumer.contract.FilterLogs(opts, "PluginRequested", idRule)
	if err != nil {
		return nil, err
	}
	return &TestAPIConsumerPluginRequestedIterator{contract: _TestAPIConsumer.contract, event: "PluginRequested", logs: logs, sub: sub}, nil
}
...
func (_TestAPIConsumer *TestAPIConsumerFilterer) WatchPluginRequested(opts *bind.WatchOpts, sink chan<- *TestAPIConsumerPluginRequested, id [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _TestAPIConsumer.contract.WatchLogs(opts, "PluginRequested", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TestAPIConsumerPluginRequested)
				if err := _TestAPIConsumer.contract.UnpackLog(event, "PluginRequested", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_TestAPIConsumer *TestAPIConsumer) ParseLog(log types.Log) (generated.AbigenLog, error) {
	switch log.Topics[0] {
	case _TestAPIConsumer.abi.Events["PluginCancelled"].ID:
		return _TestAPIConsumer.ParsePluginCancelled(log)
	case _TestAPIConsumer.abi.Events["PluginFulfilled"].ID:
		return _TestAPIConsumer.ParsePluginFulfilled(log)
	case _TestAPIConsumer.abi.Events["PluginRequested"].ID:
		return _TestAPIConsumer.ParsePluginRequested(log)
...
type TestAPIConsumerInterface interface {
	...
	GetPluginToken(opts *bind.CallOpts) (common.Address, error)
	...
	FilterPluginCancelled(opts *bind.FilterOpts, id [][32]byte) (*TestAPIConsumerPluginCancelledIterator, error)

	WatchPluginCancelled(opts *bind.WatchOpts, sink chan<- *TestAPIConsumerPluginCancelled, id [][32]byte) (event.Subscription, error)

	ParsePluginCancelled(log types.Log) (*TestAPIConsumerPluginCancelled, error)

	FilterPluginFulfilled(opts *bind.FilterOpts, id [][32]byte) (*TestAPIConsumerPluginFulfilledIterator, error)

	WatchPluginFulfilled(opts *bind.WatchOpts, sink chan<- *TestAPIConsumerPluginFulfilled, id [][32]byte) (event.Subscription, error)

	ParsePluginFulfilled(log types.Log) (*TestAPIConsumerPluginFulfilled, error)

	FilterPluginRequested(opts *bind.FilterOpts, id [][32]byte) (*TestAPIConsumerPluginRequestedIterator, error)

	WatchPluginRequested(opts *bind.WatchOpts, sink chan<- *TestAPIConsumerPluginRequested, id [][32]byte) (event.Subscription, error)

	ParsePluginRequested(log types.Log) (*TestAPIConsumerPluginRequested, error)
