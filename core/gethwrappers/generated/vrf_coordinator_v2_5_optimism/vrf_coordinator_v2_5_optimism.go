...
func (_VRFCoordinatorV25Optimism *VRFCoordinatorV25OptimismCaller) PLI(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFCoordinatorV25Optimism.contract.Call(opts, &out, "PLI")
...
func (_VRFCoordinatorV25Optimism *VRFCoordinatorV25OptimismSession) PLI() (common.Address, error) {
	return _VRFCoordinatorV25Optimism.Contract.PLI(&_VRFCoordinatorV25Optimism.CallOpts)
}

func (_VRFCoordinatorV25Optimism *VRFCoordinatorV25OptimismCallerSession) PLI() (common.Address, error) {
	return _VRFCoordinatorV25Optimism.Contract.PLI(&_VRFCoordinatorV25Optimism.CallOpts)
}

func (_VRFCoordinatorV25Optimism *VRFCoordinatorV25OptimismCaller) PLINATIVEFEED(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFCoordinatorV25Optimism.contract.Call(opts, &out, "PLI_NATIVE_FEED")
...
func (_VRFCoordinatorV25Optimism *VRFCoordinatorV25OptimismSession) PLINATIVEFEED() (common.Address, error) {
	return _VRFCoordinatorV25Optimism.Contract.PLINATIVEFEED(&_VRFCoordinatorV25Optimism.CallOpts)
}

func (_VRFCoordinatorV25Optimism *VRFCoordinatorV25OptimismCallerSession) PLINATIVEFEED() (common.Address, error) {
	return _VRFCoordinatorV25Optimism.Contract.PLINATIVEFEED(&_VRFCoordinatorV25Optimism.CallOpts)
}
...
func (_VRFCoordinatorV25Optimism *VRFCoordinatorV25OptimismTransactor) SetPLIAndPLINativeFeed(opts *bind.TransactOpts, link common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
	return _VRFCoordinatorV25Optimism.contract.Transact(opts, "setPLIAndPLINativeFeed", link, linkNativeFeed)
}

func (_VRFCoordinatorV25Optimism *VRFCoordinatorV25OptimismSession) SetPLIAndPLINativeFeed(link common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
	return _VRFCoordinatorV25Optimism.Contract.SetPLIAndPLINativeFeed(&_VRFCoordinatorV25Optimism.TransactOpts, link, linkNativeFeed)
}

func (_VRFCoordinatorV25Optimism *VRFCoordinatorV25OptimismTransactorSession) SetPLIAndPLINativeFeed(link common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
	return _VRFCoordinatorV25Optimism.Contract.SetPLIAndPLINativeFeed(&_VRFCoordinatorV25Optimism.TransactOpts, link, linkNativeFeed)
}
