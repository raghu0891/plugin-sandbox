...
type MultiWordConsumerPluginCancelledIterator struct {
	Event *MultiWordConsumerPluginCancelled
...
func (it *MultiWordConsumerPluginCancelledIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MultiWordConsumerPluginCancelled)
...
func (it *MultiWordConsumerPluginCancelledIterator) Error() error {
	return it.fail
}

func (it *MultiWordConsumerPluginCancelledIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type MultiWordConsumerPluginCancelled struct {
	Id  [32]byte
	Raw types.Log
}

func (_MultiWordConsumer *MultiWordConsumerFilterer) FilterPluginCancelled(opts *bind.FilterOpts, id [][32]byte) (*MultiWordConsumerPluginCancelledIterator, error) {
	...
	logs, sub, err := _MultiWordConsumer.contract.FilterLogs(opts, "PluginCancelled", idRule)
	if err != nil {
		return nil, err
	}
	return &MultiWordConsumerPluginCancelledIterator{contract: _MultiWordConsumer.contract, event: "PluginCancelled", logs: logs, sub: sub}, nil
}

func (_MultiWordConsumer *MultiWordConsumerFilterer) WatchPluginCancelled(opts *bind.WatchOpts, sink chan<- *MultiWordConsumerPluginCancelled, id [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _MultiWordConsumer.contract.WatchLogs(opts, "PluginCancelled", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(MultiWordConsumerPluginCancelled)
				if err := _MultiWordConsumer.contract.UnpackLog(event, "PluginCancelled", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_MultiWordConsumer *MultiWordConsumerFilterer) ParsePluginCancelled(log types.Log) (*MultiWordConsumerPluginCancelled, error) {
	event := new(MultiWordConsumerPluginCancelled)
	if err := _MultiWordConsumer.contract.UnpackLog(event, "PluginCancelled", log); err != nil {
		return nil, err
	}
...
type MultiWordConsumerPluginFulfilledIterator struct {
	Event *MultiWordConsumerPluginFulfilled
...
func (it *MultiWordConsumerPluginFulfilledIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MultiWordConsumerPluginFulfilled)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *MultiWordConsumerPluginFulfilledIterator) Error() error {
	return it.fail
}

func (it *MultiWordConsumerPluginFulfilledIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type MultiWordConsumerPluginFulfilled struct {
	Id  [32]byte
	Raw types.Log
}

func (_MultiWordConsumer *MultiWordConsumerFilterer) FilterPluginFulfilled(opts *bind.FilterOpts, id [][32]byte) (*MultiWordConsumerPluginFulfilledIterator, error) {
	...
	logs, sub, err := _MultiWordConsumer.contract.FilterLogs(opts, "PluginFulfilled", idRule)
	if err != nil {
		return nil, err
	}
	return &MultiWordConsumerPluginFulfilledIterator{contract: _MultiWordConsumer.contract, event: "PluginFulfilled", logs: logs, sub: sub}, nil
}

func (_MultiWordConsumer *MultiWordConsumerFilterer) WatchPluginFulfilled(opts *bind.WatchOpts, sink chan<- *MultiWordConsumerPluginFulfilled, id [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _MultiWordConsumer.contract.WatchLogs(opts, "PluginFulfilled", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(MultiWordConsumerPluginFulfilled)
				if err := _MultiWordConsumer.contract.UnpackLog(event, "PluginFulfilled", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_MultiWordConsumer *MultiWordConsumerFilterer) ParsePluginFulfilled(log types.Log) (*MultiWordConsumerPluginFulfilled, error) {
	event := new(MultiWordConsumerPluginFulfilled)
	if err := _MultiWordConsumer.contract.UnpackLog(event, "PluginFulfilled", log); err != nil {
		return nil, err
	}
...
type MultiWordConsumerPluginRequestedIterator struct {
	Event *MultiWordConsumerPluginRequested
...
func (it *MultiWordConsumerPluginRequestedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MultiWordConsumerPluginRequested)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *MultiWordConsumerPluginRequestedIterator) Error() error {
	return it.fail
}

func (it *MultiWordConsumerPluginRequestedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type MultiWordConsumerPluginRequested struct {
	Id  [32]byte
	Raw types.Log
}

func (_MultiWordConsumer *MultiWordConsumerFilterer) FilterPluginRequested(opts *bind.FilterOpts, id [][32]byte) (*MultiWordConsumerPluginRequestedIterator, error) {
	...
	logs, sub, err := _MultiWordConsumer.contract.FilterLogs(opts, "PluginRequested", idRule)
	if err != nil {
		return nil, err
	}
	return &MultiWordConsumerPluginRequestedIterator{contract: _MultiWordConsumer.contract, event: "PluginRequested", logs: logs, sub: sub}, nil
}

func (_MultiWordConsumer *MultiWordConsumerFilterer) WatchPluginRequested(opts *bind.WatchOpts, sink chan<- *MultiWordConsumerPluginRequested, id [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _MultiWordConsumer.contract.WatchLogs(opts, "PluginRequested", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(MultiWordConsumerPluginRequested)
				if err := _MultiWordConsumer.contract.UnpackLog(event, "PluginRequested", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_MultiWordConsumer *MultiWordConsumerFilterer) ParsePluginRequested(log types.Log) (*MultiWordConsumerPluginRequested, error) {
	event := new(MultiWordConsumerPluginRequested)
	if err := _MultiWordConsumer.contract.UnpackLog(event, "PluginRequested", log); err != nil {
		return nil, err
	}
...
func (_MultiWordConsumer *MultiWordConsumer) ParseLog(log types.Log) (generated.AbigenLog, error) {
	switch log.Topics[0] {
	case _MultiWordConsumer.abi.Events["PluginCancelled"].ID:
		return _MultiWordConsumer.ParsePluginCancelled(log)
	case _MultiWordConsumer.abi.Events["PluginFulfilled"].ID:
		return _MultiWordConsumer.ParsePluginFulfilled(log)
	case _MultiWordConsumer.abi.Events["PluginRequested"].ID:
		return _MultiWordConsumer.ParsePluginRequested(log)
...
type MultiWordConsumerInterface interface {
	...
	FilterPluginCancelled(opts *bind.FilterOpts, id [][32]byte) (*MultiWordConsumerPluginCancelledIterator, error)

	WatchPluginCancelled(opts *bind.WatchOpts, sink chan<- *MultiWordConsumerPluginCancelled, id [][32]byte) (event.Subscription, error)

	ParsePluginCancelled(log types.Log) (*MultiWordConsumerPluginCancelled, error)

	FilterPluginFulfilled(opts *bind.FilterOpts, id [][32]byte) (*MultiWordConsumerPluginFulfilledIterator, error)

	WatchPluginFulfilled(opts *bind.WatchOpts, sink chan<- *MultiWordConsumerPluginFulfilled, id [][32]byte) (event.Subscription, error)

	ParsePluginFulfilled(log types.Log) (*MultiWordConsumerPluginFulfilled, error)

	FilterPluginRequested(opts *bind.FilterOpts, id [][32]byte) (*MultiWordConsumerPluginRequestedIterator, error)

	WatchPluginRequested(opts *bind.WatchOpts, sink chan<- *MultiWordConsumerPluginRequested, id [][32]byte) (event.Subscription, error)

	ParsePluginRequested(log types.Log) (*MultiWordConsumerPluginRequested, error)
