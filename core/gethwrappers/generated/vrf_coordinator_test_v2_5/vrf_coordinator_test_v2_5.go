...
func (_VRFCoordinatorTestV25 *VRFCoordinatorTestV25Caller) PLI(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFCoordinatorTestV25.contract.Call(opts, &out, "PLI")
...
func (_VRFCoordinatorTestV25 *VRFCoordinatorTestV25Session) PLI() (common.Address, error) {
	return _VRFCoordinatorTestV25.Contract.PLI(&_VRFCoordinatorTestV25.CallOpts)
}

func (_VRFCoordinatorTestV25 *VRFCoordinatorTestV25CallerSession) PLI() (common.Address, error) {
	return _VRFCoordinatorTestV25.Contract.PLI(&_VRFCoordinatorTestV25.CallOpts)
}

func (_VRFCoordinatorTestV25 *VRFCoordinatorTestV25Caller) PLINATIVEFEED(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFCoordinatorTestV25.contract.Call(opts, &out, "PLI_NATIVE_FEED")
...
func (_VRFCoordinatorTestV25 *VRFCoordinatorTestV25Session) PLINATIVEFEED() (common.Address, error) {
	return _VRFCoordinatorTestV25.Contract.PLINATIVEFEED(&_VRFCoordinatorTestV25.CallOpts)
}

func (_VRFCoordinatorTestV25 *VRFCoordinatorTestV25CallerSession) PLINATIVEFEED() (common.Address, error) {
	return _VRFCoordinatorTestV25.Contract.PLINATIVEFEED(&_VRFCoordinatorTestV25.CallOpts)
}
...
func (_VRFCoordinatorTestV25 *VRFCoordinatorTestV25Transactor) SetPLIAndPLINativeFeed(opts *bind.TransactOpts, link common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
	return _VRFCoordinatorTestV25.contract.Transact(opts, "setPLIAndPLINativeFeed", link, linkNativeFeed)
}

func (_VRFCoordinatorTestV25 *VRFCoordinatorTestV25Session) SetPLIAndPLINativeFeed(link common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
	return _VRFCoordinatorTestV25.Contract.SetPLIAndPLINativeFeed(&_VRFCoordinatorTestV25.TransactOpts, link, linkNativeFeed)
}

func (_VRFCoordinatorTestV25 *VRFCoordinatorTestV25TransactorSession) SetPLIAndPLINativeFeed(link common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
	return _VRFCoordinatorTestV25.Contract.SetPLIAndPLINativeFeed(&_VRFCoordinatorTestV25.TransactOpts, link, linkNativeFeed)
}
