...
func (_VRFLoadTestExternalSubOwner *VRFLoadTestExternalSubOwnerCaller) PLI(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFLoadTestExternalSubOwner.contract.Call(opts, &out, "PLI")
...
func (_VRFLoadTestExternalSubOwner *VRFLoadTestExternalSubOwnerSession) PLI() (common.Address, error) {
	return _VRFLoadTestExternalSubOwner.Contract.PLI(&_VRFLoadTestExternalSubOwner.CallOpts)
}

func (_VRFLoadTestExternalSubOwner *VRFLoadTestExternalSubOwnerCallerSession) PLI() (common.Address, error) {
	return _VRFLoadTestExternalSubOwner.Contract.PLI(&_VRFLoadTestExternalSubOwner.CallOpts)
}
