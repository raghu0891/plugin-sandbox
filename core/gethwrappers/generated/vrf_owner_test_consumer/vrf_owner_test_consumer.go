...
func (_VRFV2OwnerTestConsumer *VRFV2OwnerTestConsumerCaller) PLITOKEN(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFV2OwnerTestConsumer.contract.Call(opts, &out, "PLITOKEN")
...
func (_VRFV2OwnerTestConsumer *VRFV2OwnerTestConsumerSession) PLITOKEN() (common.Address, error) {
	return _VRFV2OwnerTestConsumer.Contract.PLITOKEN(&_VRFV2OwnerTestConsumer.CallOpts)
}

func (_VRFV2OwnerTestConsumer *VRFV2OwnerTestConsumerCallerSession) PLITOKEN() (common.Address, error) {
	return _VRFV2OwnerTestConsumer.Contract.PLITOKEN(&_VRFV2OwnerTestConsumer.CallOpts)
}
