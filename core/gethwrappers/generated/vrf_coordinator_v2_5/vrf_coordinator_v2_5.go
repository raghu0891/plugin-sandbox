...
func (_VRFCoordinatorV25 *VRFCoordinatorV25Caller) PLI(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFCoordinatorV25.contract.Call(opts, &out, "PLI")
...
func (_VRFCoordinatorV25 *VRFCoordinatorV25Session) PLI() (common.Address, error) {
	return _VRFCoordinatorV25.Contract.PLI(&_VRFCoordinatorV25.CallOpts)
}

func (_VRFCoordinatorV25 *VRFCoordinatorV25CallerSession) PLI() (common.Address, error) {
	return _VRFCoordinatorV25.Contract.PLI(&_VRFCoordinatorV25.CallOpts)
}

func (_VRFCoordinatorV25 *VRFCoordinatorV25Caller) PLINATIVEFEED(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFCoordinatorV25.contract.Call(opts, &out, "PLI_NATIVE_FEED")
...
func (_VRFCoordinatorV25 *VRFCoordinatorV25Session) PLINATIVEFEED() (common.Address, error) {
	return _VRFCoordinatorV25.Contract.PLINATIVEFEED(&_VRFCoordinatorV25.CallOpts)
}

func (_VRFCoordinatorV25 *VRFCoordinatorV25CallerSession) PLINATIVEFEED() (common.Address, error) {
	return _VRFCoordinatorV25.Contract.PLINATIVEFEED(&_VRFCoordinatorV25.CallOpts)
}
...
func (_VRFCoordinatorV25 *VRFCoordinatorV25Transactor) SetPLIAndPLINativeFeed(opts *bind.TransactOpts, link common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
	return _VRFCoordinatorV25.contract.Transact(opts, "setPLIAndPLINativeFeed", link, linkNativeFeed)
}

func (_VRFCoordinatorV25 *VRFCoordinatorV25Session) SetPLIAndPLINativeFeed(link common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
	return _VRFCoordinatorV25.Contract.SetPLIAndPLINativeFeed(&_VRFCoordinatorV25.TransactOpts, link, linkNativeFeed)
}

func (_VRFCoordinatorV25 *VRFCoordinatorV25TransactorSession) SetPLIAndPLINativeFeed(link common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
	return _VRFCoordinatorV25.Contract.SetPLIAndPLINativeFeed(&_VRFCoordinatorV25.TransactOpts, link, linkNativeFeed)
}
