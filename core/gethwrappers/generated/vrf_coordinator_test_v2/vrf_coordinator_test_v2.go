...
func (_VRFCoordinatorTestV2 *VRFCoordinatorTestV2Caller) PLI(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFCoordinatorTestV2.contract.Call(opts, &out, "PLI")
...
func (_VRFCoordinatorTestV2 *VRFCoordinatorTestV2Session) PLI() (common.Address, error) {
	return _VRFCoordinatorTestV2.Contract.PLI(&_VRFCoordinatorTestV2.CallOpts)
}

func (_VRFCoordinatorTestV2 *VRFCoordinatorTestV2CallerSession) PLI() (common.Address, error) {
	return _VRFCoordinatorTestV2.Contract.PLI(&_VRFCoordinatorTestV2.CallOpts)
}

func (_VRFCoordinatorTestV2 *VRFCoordinatorTestV2Caller) PLIETHFEED(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFCoordinatorTestV2.contract.Call(opts, &out, "PLI_ETH_FEED")
...
func (_VRFCoordinatorTestV2 *VRFCoordinatorTestV2Session) PLIETHFEED() (common.Address, error) {
	return _VRFCoordinatorTestV2.Contract.PLIETHFEED(&_VRFCoordinatorTestV2.CallOpts)
}

func (_VRFCoordinatorTestV2 *VRFCoordinatorTestV2CallerSession) PLIETHFEED() (common.Address, error) {
	return _VRFCoordinatorTestV2.Contract.PLIETHFEED(&_VRFCoordinatorTestV2.CallOpts)
}
...
type VRFCoordinatorTestV2Interface interface {
	...
	PLIETHFEED(opts *bind.CallOpts) (common.Address, error)
