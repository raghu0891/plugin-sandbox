...
func (_VRFV2Wrapper *VRFV2WrapperCaller) PLI(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFV2Wrapper.contract.Call(opts, &out, "PLI")
...
func (_VRFV2Wrapper *VRFV2WrapperSession) PLI() (common.Address, error) {
	return _VRFV2Wrapper.Contract.PLI(&_VRFV2Wrapper.CallOpts)
}

func (_VRFV2Wrapper *VRFV2WrapperCallerSession) PLI() (common.Address, error) {
	return _VRFV2Wrapper.Contract.PLI(&_VRFV2Wrapper.CallOpts)
}

func (_VRFV2Wrapper *VRFV2WrapperCaller) PLIETHFEED(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFV2Wrapper.contract.Call(opts, &out, "PLI_ETH_FEED")
...
func (_VRFV2Wrapper *VRFV2WrapperSession) PLIETHFEED() (common.Address, error) {
	return _VRFV2Wrapper.Contract.PLIETHFEED(&_VRFV2Wrapper.CallOpts)
}

func (_VRFV2Wrapper *VRFV2WrapperCallerSession) PLIETHFEED() (common.Address, error) {
	return _VRFV2Wrapper.Contract.PLIETHFEED(&_VRFV2Wrapper.CallOpts)
}
