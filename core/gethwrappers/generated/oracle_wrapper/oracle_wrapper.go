...
func (_Oracle *OracleCaller) GetPluginToken(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Oracle.contract.Call(opts, &out, "getPluginToken")
...
func (_Oracle *OracleSession) GetPluginToken() (common.Address, error) {
	return _Oracle.Contract.GetPluginToken(&_Oracle.CallOpts)
}

func (_Oracle *OracleCallerSession) GetPluginToken() (common.Address, error) {
	return _Oracle.Contract.GetPluginToken(&_Oracle.CallOpts)
}
