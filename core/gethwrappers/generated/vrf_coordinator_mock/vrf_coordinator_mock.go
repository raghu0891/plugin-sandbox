...
func (_VRFCoordinatorMock *VRFCoordinatorMockCaller) PLI(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFCoordinatorMock.contract.Call(opts, &out, "PLI")
...
func (_VRFCoordinatorMock *VRFCoordinatorMockSession) PLI() (common.Address, error) {
	return _VRFCoordinatorMock.Contract.PLI(&_VRFCoordinatorMock.CallOpts)
}

func (_VRFCoordinatorMock *VRFCoordinatorMockCallerSession) PLI() (common.Address, error) {
	return _VRFCoordinatorMock.Contract.PLI(&_VRFCoordinatorMock.CallOpts)
}
