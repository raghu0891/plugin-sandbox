...
func (_VRFCoordinatorV2 *VRFCoordinatorV2Caller) PLI(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFCoordinatorV2.contract.Call(opts, &out, "PLI")
...
func (_VRFCoordinatorV2 *VRFCoordinatorV2Session) PLI() (common.Address, error) {
	return _VRFCoordinatorV2.Contract.PLI(&_VRFCoordinatorV2.CallOpts)
}

func (_VRFCoordinatorV2 *VRFCoordinatorV2CallerSession) PLI() (common.Address, error) {
	return _VRFCoordinatorV2.Contract.PLI(&_VRFCoordinatorV2.CallOpts)
}

func (_VRFCoordinatorV2 *VRFCoordinatorV2Caller) PLIETHFEED(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFCoordinatorV2.contract.Call(opts, &out, "PLI_ETH_FEED")
...
func (_VRFCoordinatorV2 *VRFCoordinatorV2Session) PLIETHFEED() (common.Address, error) {
	return _VRFCoordinatorV2.Contract.PLIETHFEED(&_VRFCoordinatorV2.CallOpts)
}

func (_VRFCoordinatorV2 *VRFCoordinatorV2CallerSession) PLIETHFEED() (common.Address, error) {
	return _VRFCoordinatorV2.Contract.PLIETHFEED(&_VRFCoordinatorV2.CallOpts)
}
