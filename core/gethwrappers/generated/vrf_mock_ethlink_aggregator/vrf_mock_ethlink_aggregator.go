...
func (_VRFMockETHPLIAggregator *VRFMockETHPLIAggregatorCaller) GetRoundData(opts *bind.CallOpts, arg0 *big.Int) (GetRoundData,

	error) {
	var out []interface{}
	err := _VRFMockETHPLIAggregator.contract.Call(opts, &out, "getRoundData", arg0)
...
func (_VRFMockETHPLIAggregator *VRFMockETHPLIAggregatorSession) GetRoundData(arg0 *big.Int) (GetRoundData,

	error) {
	return _VRFMockETHPLIAggregator.Contract.GetRoundData(&_VRFMockETHPLIAggregator.CallOpts, arg0)
}

func (_VRFMockETHPLIAggregator *VRFMockETHPLIAggregatorCallerSession) GetRoundData(arg0 *big.Int) (GetRoundData,
