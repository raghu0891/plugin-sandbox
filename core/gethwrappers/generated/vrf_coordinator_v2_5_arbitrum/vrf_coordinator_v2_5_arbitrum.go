...
func (_VRFCoordinatorV25Arbitrum *VRFCoordinatorV25ArbitrumCaller) PLI(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFCoordinatorV25Arbitrum.contract.Call(opts, &out, "PLI")
...
func (_VRFCoordinatorV25Arbitrum *VRFCoordinatorV25ArbitrumSession) PLI() (common.Address, error) {
	return _VRFCoordinatorV25Arbitrum.Contract.PLI(&_VRFCoordinatorV25Arbitrum.CallOpts)
}

func (_VRFCoordinatorV25Arbitrum *VRFCoordinatorV25ArbitrumCallerSession) PLI() (common.Address, error) {
	return _VRFCoordinatorV25Arbitrum.Contract.PLI(&_VRFCoordinatorV25Arbitrum.CallOpts)
}

func (_VRFCoordinatorV25Arbitrum *VRFCoordinatorV25ArbitrumCaller) PLINATIVEFEED(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFCoordinatorV25Arbitrum.contract.Call(opts, &out, "PLI_NATIVE_FEED")
...
func (_VRFCoordinatorV25Arbitrum *VRFCoordinatorV25ArbitrumSession) PLINATIVEFEED() (common.Address, error) {
	return _VRFCoordinatorV25Arbitrum.Contract.PLINATIVEFEED(&_VRFCoordinatorV25Arbitrum.CallOpts)
}

func (_VRFCoordinatorV25Arbitrum *VRFCoordinatorV25ArbitrumCallerSession) PLINATIVEFEED() (common.Address, error) {
	return _VRFCoordinatorV25Arbitrum.Contract.PLINATIVEFEED(&_VRFCoordinatorV25Arbitrum.CallOpts)
}
...
func (_VRFCoordinatorV25Arbitrum *VRFCoordinatorV25ArbitrumTransactor) SetPLIAndPLINativeFeed(opts *bind.TransactOpts, link common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
	return _VRFCoordinatorV25Arbitrum.contract.Transact(opts, "setPLIAndPLINativeFeed", link, linkNativeFeed)
}

func (_VRFCoordinatorV25Arbitrum *VRFCoordinatorV25ArbitrumSession) SetPLIAndPLINativeFeed(link common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
	return _VRFCoordinatorV25Arbitrum.Contract.SetPLIAndPLINativeFeed(&_VRFCoordinatorV25Arbitrum.TransactOpts, link, linkNativeFeed)
}

func (_VRFCoordinatorV25Arbitrum *VRFCoordinatorV25ArbitrumTransactorSession) SetPLIAndPLINativeFeed(link common.Address, linkNativeFeed common.Address) (*types.Transaction, error) {
	return _VRFCoordinatorV25Arbitrum.Contract.SetPLIAndPLINativeFeed(&_VRFCoordinatorV25Arbitrum.TransactOpts, link, linkNativeFeed)
}
