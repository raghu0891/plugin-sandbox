...
func (_KeeperRegistrarMock *KeeperRegistrarMockCaller) GetRegistrationConfig(opts *bind.CallOpts) (GetRegistrationConfig,
	...
	outstruct.MinPLIJuels = *abi.ConvertType(out[4], new(*big.Int)).(**big.Int)
...
func (_KeeperRegistrarMock *KeeperRegistrarMockCaller) SMinPLIJuels(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _KeeperRegistrarMock.contract.Call(opts, &out, "s_minPLIJuels")
...
func (_KeeperRegistrarMock *KeeperRegistrarMockSession) SMinPLIJuels() (*big.Int, error) {
	return _KeeperRegistrarMock.Contract.SMinPLIJuels(&_KeeperRegistrarMock.CallOpts)
}

func (_KeeperRegistrarMock *KeeperRegistrarMockCallerSession) SMinPLIJuels() (*big.Int, error) {
	return _KeeperRegistrarMock.Contract.SMinPLIJuels(&_KeeperRegistrarMock.CallOpts)
}
...
func (_KeeperRegistrarMock *KeeperRegistrarMockTransactor) EmitConfigChanged(opts *bind.TransactOpts, autoApproveConfigType uint8, autoApproveMaxAllowed uint32, keeperRegistry common.Address, minPLIJuels *big.Int) (*types.Transaction, error) {
	return _KeeperRegistrarMock.contract.Transact(opts, "emitConfigChanged", autoApproveConfigType, autoApproveMaxAllowed, keeperRegistry, minPLIJuels)
}

func (_KeeperRegistrarMock *KeeperRegistrarMockSession) EmitConfigChanged(autoApproveConfigType uint8, autoApproveMaxAllowed uint32, keeperRegistry common.Address, minPLIJuels *big.Int) (*types.Transaction, error) {
	return _KeeperRegistrarMock.Contract.EmitConfigChanged(&_KeeperRegistrarMock.TransactOpts, autoApproveConfigType, autoApproveMaxAllowed, keeperRegistry, minPLIJuels)
}

func (_KeeperRegistrarMock *KeeperRegistrarMockTransactorSession) EmitConfigChanged(autoApproveConfigType uint8, autoApproveMaxAllowed uint32, keeperRegistry common.Address, minPLIJuels *big.Int) (*types.Transaction, error) {
	return _KeeperRegistrarMock.Contract.EmitConfigChanged(&_KeeperRegistrarMock.TransactOpts, autoApproveConfigType, autoApproveMaxAllowed, keeperRegistry, minPLIJuels)
}
...
func (_KeeperRegistrarMock *KeeperRegistrarMockTransactor) SetRegistrationConfig(opts *bind.TransactOpts, _autoApproveConfigType uint8, _autoApproveMaxAllowed uint32, _approvedCount uint32, _keeperRegistry common.Address, _minPLIJuels *big.Int) (*types.Transaction, error) {
	return _KeeperRegistrarMock.contract.Transact(opts, "setRegistrationConfig", _autoApproveConfigType, _autoApproveMaxAllowed, _approvedCount, _keeperRegistry, _minPLIJuels)
}

func (_KeeperRegistrarMock *KeeperRegistrarMockSession) SetRegistrationConfig(_autoApproveConfigType uint8, _autoApproveMaxAllowed uint32, _approvedCount uint32, _keeperRegistry common.Address, _minPLIJuels *big.Int) (*types.Transaction, error) {
	return _KeeperRegistrarMock.Contract.SetRegistrationConfig(&_KeeperRegistrarMock.TransactOpts, _autoApproveConfigType, _autoApproveMaxAllowed, _approvedCount, _keeperRegistry, _minPLIJuels)
}

func (_KeeperRegistrarMock *KeeperRegistrarMockTransactorSession) SetRegistrationConfig(_autoApproveConfigType uint8, _autoApproveMaxAllowed uint32, _approvedCount uint32, _keeperRegistry common.Address, _minPLIJuels *big.Int) (*types.Transaction, error) {
	return _KeeperRegistrarMock.Contract.SetRegistrationConfig(&_KeeperRegistrarMock.TransactOpts, _autoApproveConfigType, _autoApproveMaxAllowed, _approvedCount, _keeperRegistry, _minPLIJuels)
}
...
type KeeperRegistrarMockInterface interface {
	...
	SMinPLIJuels(opts *bind.CallOpts) (*big.Int, error)

	EmitAutoApproveAllowedSenderSet(opts *bind.TransactOpts, senderAddress common.Address, allowed bool) (*types.Transaction, error)

	EmitConfigChanged(opts *bind.TransactOpts, autoApproveConfigType uint8, autoApproveMaxAllowed uint32, keeperRegistry common.Address, minPLIJuels *big.Int) (*types.Transaction, error)
	...
	SetRegistrationConfig(opts *bind.TransactOpts, _autoApproveConfigType uint8, _autoApproveMaxAllowed uint32, _approvedCount uint32, _keeperRegistry common.Address, _minPLIJuels *big.Int) (*types.Transaction, error)
