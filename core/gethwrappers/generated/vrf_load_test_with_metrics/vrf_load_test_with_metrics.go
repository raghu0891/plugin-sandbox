...
func (_VRFV2LoadTestWithMetrics *VRFV2LoadTestWithMetricsCaller) PLITOKEN(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _VRFV2LoadTestWithMetrics.contract.Call(opts, &out, "PLITOKEN")
...
func (_VRFV2LoadTestWithMetrics *VRFV2LoadTestWithMetricsSession) PLITOKEN() (common.Address, error) {
	return _VRFV2LoadTestWithMetrics.Contract.PLITOKEN(&_VRFV2LoadTestWithMetrics.CallOpts)
}

func (_VRFV2LoadTestWithMetrics *VRFV2LoadTestWithMetricsCallerSession) PLITOKEN() (common.Address, error) {
	return _VRFV2LoadTestWithMetrics.Contract.PLITOKEN(&_VRFV2LoadTestWithMetrics.CallOpts)
}
