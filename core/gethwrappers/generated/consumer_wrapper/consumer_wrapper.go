...
type ConsumerPluginCancelledIterator struct {
	Event *ConsumerPluginCancelled
...
func (it *ConsumerPluginCancelledIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ConsumerPluginCancelled)
...
func (it *ConsumerPluginCancelledIterator) Error() error {
	return it.fail
}

func (it *ConsumerPluginCancelledIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type ConsumerPluginCancelled struct {
	Id  [32]byte
	Raw types.Log
}

func (_Consumer *ConsumerFilterer) FilterPluginCancelled(opts *bind.FilterOpts, id [][32]byte) (*ConsumerPluginCancelledIterator, error) {
	...
	logs, sub, err := _Consumer.contract.FilterLogs(opts, "PluginCancelled", idRule)
	if err != nil {
		return nil, err
	}
	return &ConsumerPluginCancelledIterator{contract: _Consumer.contract, event: "PluginCancelled", logs: logs, sub: sub}, nil
}

func (_Consumer *ConsumerFilterer) WatchPluginCancelled(opts *bind.WatchOpts, sink chan<- *ConsumerPluginCancelled, id [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _Consumer.contract.WatchLogs(opts, "PluginCancelled", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ConsumerPluginCancelled)
				if err := _Consumer.contract.UnpackLog(event, "PluginCancelled", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_Consumer *ConsumerFilterer) ParsePluginCancelled(log types.Log) (*ConsumerPluginCancelled, error) {
	event := new(ConsumerPluginCancelled)
	if err := _Consumer.contract.UnpackLog(event, "PluginCancelled", log); err != nil {
		return nil, err
	}
...
type ConsumerPluginFulfilledIterator struct {
	Event *ConsumerPluginFulfilled
...
func (it *ConsumerPluginFulfilledIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ConsumerPluginFulfilled)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *ConsumerPluginFulfilledIterator) Error() error {
	return it.fail
}

func (it *ConsumerPluginFulfilledIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type ConsumerPluginFulfilled struct {
	Id  [32]byte
	Raw types.Log
}

func (_Consumer *ConsumerFilterer) FilterPluginFulfilled(opts *bind.FilterOpts, id [][32]byte) (*ConsumerPluginFulfilledIterator, error) {
	...
	logs, sub, err := _Consumer.contract.FilterLogs(opts, "PluginFulfilled", idRule)
	if err != nil {
		return nil, err
	}
	return &ConsumerPluginFulfilledIterator{contract: _Consumer.contract, event: "PluginFulfilled", logs: logs, sub: sub}, nil
}

func (_Consumer *ConsumerFilterer) WatchPluginFulfilled(opts *bind.WatchOpts, sink chan<- *ConsumerPluginFulfilled, id [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _Consumer.contract.WatchLogs(opts, "PluginFulfilled", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ConsumerPluginFulfilled)
				if err := _Consumer.contract.UnpackLog(event, "PluginFulfilled", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_Consumer *ConsumerFilterer) ParsePluginFulfilled(log types.Log) (*ConsumerPluginFulfilled, error) {
	event := new(ConsumerPluginFulfilled)
	if err := _Consumer.contract.UnpackLog(event, "PluginFulfilled", log); err != nil {
		return nil, err
	}
...
type ConsumerPluginRequestedIterator struct {
	Event *ConsumerPluginRequested
...
func (it *ConsumerPluginRequestedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ConsumerPluginRequested)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
func (it *ConsumerPluginRequestedIterator) Error() error {
	return it.fail
}

func (it *ConsumerPluginRequestedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

type ConsumerPluginRequested struct {
	Id  [32]byte
	Raw types.Log
}

func (_Consumer *ConsumerFilterer) FilterPluginRequested(opts *bind.FilterOpts, id [][32]byte) (*ConsumerPluginRequestedIterator, error) {
	...
	logs, sub, err := _Consumer.contract.FilterLogs(opts, "PluginRequested", idRule)
	if err != nil {
		return nil, err
	}
	return &ConsumerPluginRequestedIterator{contract: _Consumer.contract, event: "PluginRequested", logs: logs, sub: sub}, nil
}

func (_Consumer *ConsumerFilterer) WatchPluginRequested(opts *bind.WatchOpts, sink chan<- *ConsumerPluginRequested, id [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _Consumer.contract.WatchLogs(opts, "PluginRequested", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ConsumerPluginRequested)
				if err := _Consumer.contract.UnpackLog(event, "PluginRequested", log); err != nil {
					return err
				}
				event.Raw = log
...
func (_Consumer *ConsumerFilterer) ParsePluginRequested(log types.Log) (*ConsumerPluginRequested, error) {
	event := new(ConsumerPluginRequested)
	if err := _Consumer.contract.UnpackLog(event, "PluginRequested", log); err != nil {
		return nil, err
	}
...
func (_Consumer *Consumer) ParseLog(log types.Log) (generated.AbigenLog, error) {
	switch log.Topics[0] {
	case _Consumer.abi.Events["PluginCancelled"].ID:
		return _Consumer.ParsePluginCancelled(log)
	case _Consumer.abi.Events["PluginFulfilled"].ID:
		return _Consumer.ParsePluginFulfilled(log)
	case _Consumer.abi.Events["PluginRequested"].ID:
		return _Consumer.ParsePluginRequested(log)
...
type ConsumerInterface interface {
	...
	FilterPluginCancelled(opts *bind.FilterOpts, id [][32]byte) (*ConsumerPluginCancelledIterator, error)

	WatchPluginCancelled(opts *bind.WatchOpts, sink chan<- *ConsumerPluginCancelled, id [][32]byte) (event.Subscription, error)

	ParsePluginCancelled(log types.Log) (*ConsumerPluginCancelled, error)

	FilterPluginFulfilled(opts *bind.FilterOpts, id [][32]byte) (*ConsumerPluginFulfilledIterator, error)

	WatchPluginFulfilled(opts *bind.WatchOpts, sink chan<- *ConsumerPluginFulfilled, id [][32]byte) (event.Subscription, error)

	ParsePluginFulfilled(log types.Log) (*ConsumerPluginFulfilled, error)

	FilterPluginRequested(opts *bind.FilterOpts, id [][32]byte) (*ConsumerPluginRequestedIterator, error)

	WatchPluginRequested(opts *bind.WatchOpts, sink chan<- *ConsumerPluginRequested, id [][32]byte) (event.Subscription, error)

	ParsePluginRequested(log types.Log) (*ConsumerPluginRequested, error)
