...
var LinkTokenReceiverMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"name\":\"getPluginToken\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"},{\"internalType\":\"bytes\",\"name\":\"data\",\"type\":\"bytes\"}],\"name\":\"onTokenTransfer\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
func (_LinkTokenReceiver *LinkTokenReceiverCaller) GetPluginToken(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _LinkTokenReceiver.contract.Call(opts, &out, "getPluginToken")
...
func (_LinkTokenReceiver *LinkTokenReceiverSession) GetPluginToken() (common.Address, error) {
	return _LinkTokenReceiver.Contract.GetPluginToken(&_LinkTokenReceiver.CallOpts)
}

func (_LinkTokenReceiver *LinkTokenReceiverCallerSession) GetPluginToken() (common.Address, error) {
	return _LinkTokenReceiver.Contract.GetPluginToken(&_LinkTokenReceiver.CallOpts)
}
