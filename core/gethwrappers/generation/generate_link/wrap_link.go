...
import (
	...
	gethwrappers2 "github.com/goplugin/pluginv3.0/v2/core/gethwrappers"
...
func main() {
	...
	if bin == "" {
		gethwrappers2.Exit("could not extract PLI bytecode", nil)
	}
