...
import (
	...
	bridgesMocks "github.com/goplugin/pluginv3.0/v2/core/bridges/mocks"
	...
	"github.com/goplugin/pluginv3.0/v2/core/services/pipeline/mocks"
	"github.com/goplugin/pluginv3.0/v2/core/utils"

	"github.com/jmoiron/sqlx"
)

func newRunner(t testing.TB, db *sqlx.DB, bridgeORM bridges.ORM, cfg plugin.GeneralConfig) (pipeline.Runner, *mocks.ORM) {
...
func Test_PipelineRunner_ExecuteTaskRunsWithVars(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			vars: map[string]interface{}{
				"foo": []interface{}{float64(123), "plugin"},
				"bar": float64(123.45),
				"baz": "such oracle",
			},
		...
		},
		{
			...
			vars: map[string]interface{}{
				...
				"bar": map[string]interface{}{"steve": "plugin"},
				"baz": true,
			},
...
func Test_PipelineRunner_AsyncJob_Basic(t *testing.T) {
	...
	handler := http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("X-Plugin-Pending", "true")
