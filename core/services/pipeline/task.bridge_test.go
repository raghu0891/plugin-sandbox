...
import (
	...
	"github.com/goplugin/pluginv3.0/v2/core/services/pipeline/internal/eautils"
...
// external adapters.
// https://github.com/goplugin/price-adapters
...
// https://github.com/goplugin/bnc-adapter
...
func TestBridgeTask_DoesNotReturnStaleResults(t *testing.T) {
	...
	cfg2 := configtest.NewGeneralConfig(t, func(c *plugin.Config, s *plugin.Secrets) {
...
// https://github.com/goplugin/price-adapters#plugin-price-request-adapters
