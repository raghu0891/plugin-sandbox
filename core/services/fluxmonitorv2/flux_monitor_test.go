...
import (
	...
	corenull "github.com/goplugin/pluginv3.0/v2/core/null"
	"github.com/goplugin/pluginv3.0/v2/core/services/fluxmonitorv2"
	fmmocks "github.com/goplugin/pluginv3.0/v2/core/services/fluxmonitorv2/mocks"
...
var (
	defaultMinimumContractPayment = assets.NewLinkFromJuels(10_000_000_000_000) // 0.00001 PLI
)
