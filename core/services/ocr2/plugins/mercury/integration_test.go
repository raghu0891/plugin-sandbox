...
import (
	...
	datastreamsmercury "github.com/goplugin/plugin-data-streams/mercury"
...
func integration_MercuryV1(t *testing.T) {
	...
	linkFeed := Feed{"PLI/USD", randomFeedID(1), big.NewInt(7150 * multiplier / 1000), big.NewInt(7123 * multiplier / 1000), big.NewInt(7177 * multiplier / 1000), 0}
