...
import (
	...
	"github.com/goplugin/pluginv3.0/v2/core/services/ocr2/plugins/ccip/internal/logpollerutil"
...
func NewPriceRegistry(lggr logger.Logger, priceRegistryAddr common.Address, lp logpoller.LogPoller, ec client.Client, registerFilters bool) (*PriceRegistry, error) {
	...
	priceRegABI := abihelpers.MustParseABI(price_registry_1_2_0.PriceRegistryABI)
...
// See https://github.com/goplugin/ccip/blob/ccip-develop/contracts/src/v0.8/ccip/PriceRegistry.sol#L141
