...
import (
	...
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/ccip/generated/commit_store_helper"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/ccip/generated/commit_store_helper_1_2_0"
...
func SetupCCIPContracts(t *testing.T, sourceChainID, sourceChainSelector, destChainID, destChainSelector uint64,
	...
	require.NoError(t, err)
	t.Logf("Deloyed PLI token on source chain at %s", sourceLinkTokenAddress.String())
	...
	require.NoError(t, err)
	t.Logf("Deloyed PLI token on dest chain at %s", destLinkTokenAddress.String())
