...
import (
	...
	types4 "github.com/goplugin/plugin-libocr/offchainreporting2plus/types"
	...
	evmUtils "github.com/goplugin/pluginv3.0/v2/core/chains/evm/utils/big"
	"github.com/goplugin/pluginv3.0/v2/core/chains/legacyevm"
	configv2 "github.com/goplugin/pluginv3.0/v2/core/config/toml"
	...
	"github.com/goplugin/pluginv3.0/v2/core/services/ocr2/plugins/ccip/internal/ccipdata/v1_5_0"
	...
	clutils "github.com/goplugin/pluginv3.0/v2/core/utils"
	"github.com/goplugin/pluginv3.0/v2/core/utils/crypto"
...
func setupNodeCCIP(
	...
	config, db := heavyweight.FullTestDBNoFixturesV2(t, func(c *plugin.Config, _ *plugin.Secrets) {
		p2pAddresses := []string{
	...
	// signs 1337 see https://github.com/goplugin/plugin-ccip/blob/a24dd436810250a458d27d8bb3fb78096afeb79c/core/services/ocr2/plugins/ccip/testhelpers/simulated_backend.go#L35
	...
	initOps := []plugin.CoreRelayerChainInitFunc{
		plugin.InitEVM(testCtx, relayerFactory, evmOpts),
	}
	...
	app, err := plugin.NewApplication(plugin.ApplicationOpts{
		Config:                     config,
		DS:                         db,
		KeyStore:                   keyStore,
