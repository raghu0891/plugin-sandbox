...
import (
	...
	evmregistry21 "github.com/goplugin/pluginv3.0/v2/core/services/ocr2/plugins/ocr2keeper/evmregistry/v21/core"
...
func setupDB(t *testing.T) *sqlx.DB {
	_, db := heavyweight.FullTestDBV2(t, func(c *plugin.Config, s *plugin.Secrets) {
