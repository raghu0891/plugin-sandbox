...
// StarknetLooppSigner implements [github.com/goplugin/plugin-common/pkg/loop.Keystore] interface and the requirements
// of signature d/encoding of the [github.com/goplugin/plugin-starknet/relayer/pkg/plugin/txm.NewKeystoreAdapter]
...
// the returned []byte is an encoded [github.com/goplugin/plugin-common/pkg/loop/adapters/starknet.Signature].
// this enables compatibility with [github.com/goplugin/plugin-starknet/relayer/pkg/plugin/txm.NewKeystoreAdapter]
