...
import (
	...
	v4types "github.com/goplugin/plugin-common/pkg/types/mercury/v4"
	v4 "github.com/goplugin/plugin-data-streams/mercury/v4"
	...
	"github.com/goplugin/pluginv3.0/v2/core/services/relay/evm/mercury/v4/reportcodec"
	...
	if len(ds.jb.OCR2OracleSpec.PluginConfig) == 0 {
		...
		go func() {
			...
			if obs.LinkPrice.Val == nil && obs.LinkPrice.Err == nil {
				...
				ds.lggr.Warnw(fmt.Sprintf("Mercury server was missing PLI feed, using sentinel value of %s", v4.MissingPrice), "linkFeedID", ds.linkFeedID)
				obs.LinkPrice.Val = v4.MissingPrice
