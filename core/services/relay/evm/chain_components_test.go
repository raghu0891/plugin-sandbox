...
import (
	...
	evmtxmgr "github.com/goplugin/pluginv3.0/v2/core/chains/evm/txmgr"
	...
	keytypes "github.com/goplugin/pluginv3.0/v2/core/services/keystore/keys/ethkey"
	. "github.com/goplugin/pluginv3.0/v2/core/services/relay/evm/evmtesting" //nolint common practice to import test mods with .
)
...
func (h *helper) TXM(t *testing.T, client client.Client) evmtxmgr.TxManager {
	...
	clconfig := configtest.NewGeneralConfigSimulated(t, func(c *plugin.Config, s *plugin.Secrets) {
