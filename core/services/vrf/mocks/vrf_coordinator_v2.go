...
import (
	...
	vrf_coordinator_v2 "github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_coordinator_v2"
)
...
// PLI provides a mock function with given fields: opts
func (_m *VRFCoordinatorV2Interface) PLI(opts *bind.CallOpts) (common.Address, error) {
	ret := _m.Called(opts)

	if len(ret) == 0 {
		panic("no return value specified for PLI")
	}
...
// VRFCoordinatorV2Interface_PLI_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PLI'
type VRFCoordinatorV2Interface_PLI_Call struct {
	*mock.Call
}

// PLI is a helper method to define mock.On call
//   - opts *bind.CallOpts
func (_e *VRFCoordinatorV2Interface_Expecter) PLI(opts interface{}) *VRFCoordinatorV2Interface_PLI_Call {
	return &VRFCoordinatorV2Interface_PLI_Call{Call: _e.mock.On("PLI", opts)}
}

func (_c *VRFCoordinatorV2Interface_PLI_Call) Run(run func(opts *bind.CallOpts)) *VRFCoordinatorV2Interface_PLI_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*bind.CallOpts))
	})
	return _c
...
func (_c *VRFCoordinatorV2Interface_PLI_Call) Return(_a0 common.Address, _a1 error) *VRFCoordinatorV2Interface_PLI_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *VRFCoordinatorV2Interface_PLI_Call) RunAndReturn(run func(*bind.CallOpts) (common.Address, error)) *VRFCoordinatorV2Interface_PLI_Call {
	_c.Call.Return(run)
	return _c
}

// PLIETHFEED provides a mock function with given fields: opts
func (_m *VRFCoordinatorV2Interface) PLIETHFEED(opts *bind.CallOpts) (common.Address, error) {
	ret := _m.Called(opts)

	if len(ret) == 0 {
		panic("no return value specified for PLIETHFEED")
	}
...
// VRFCoordinatorV2Interface_PLIETHFEED_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PLIETHFEED'
type VRFCoordinatorV2Interface_PLIETHFEED_Call struct {
	*mock.Call
}

// PLIETHFEED is a helper method to define mock.On call
//   - opts *bind.CallOpts
func (_e *VRFCoordinatorV2Interface_Expecter) PLIETHFEED(opts interface{}) *VRFCoordinatorV2Interface_PLIETHFEED_Call {
	return &VRFCoordinatorV2Interface_PLIETHFEED_Call{Call: _e.mock.On("PLIETHFEED", opts)}
}

func (_c *VRFCoordinatorV2Interface_PLIETHFEED_Call) Run(run func(opts *bind.CallOpts)) *VRFCoordinatorV2Interface_PLIETHFEED_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*bind.CallOpts))
	})
	return _c
...
func (_c *VRFCoordinatorV2Interface_PLIETHFEED_Call) Return(_a0 common.Address, _a1 error) *VRFCoordinatorV2Interface_PLIETHFEED_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *VRFCoordinatorV2Interface_PLIETHFEED_Call) RunAndReturn(run func(*bind.CallOpts) (common.Address, error)) *VRFCoordinatorV2Interface_PLIETHFEED_Call {
	_c.Call.Return(run)
	return _c
}
