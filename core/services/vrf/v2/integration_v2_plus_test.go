...
import (
	...
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/batch_vrf_coordinator_v2plus"
	...
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/trusted_blockhash_store"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_consumer_v2_plus_upgradeable_example"
	...
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_coordinator_v2_plus_v2_example"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_coordinator_v2plus_interface"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_malicious_consumer_v2_plus"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_v2plus_single_consumer"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_v2plus_sub_owner"
	...
	"github.com/goplugin/pluginv3.0/v2/core/services/vrf/extraargs"
...
func newVRFCoordinatorV2PlusUniverse(t *testing.T, key ethkey.KeyV2, numConsumers int, trusting bool) coordinatorV2PlusUniverse {
	...
	_, err = coordinatorContract.SetPLIAndPLINativeFeed(neil, linkAddress, linkEthFeed)
	require.NoError(t, err)
	backend.Commit()
	...
	for _, author := range vrfConsumers {
		...
		_, err2 = linkContract.Transfer(sergey, consumerContractAddress, assets.Ether(500).ToInt()) // Actually, PLI
	...
	_, err = linkContract.Transfer(sergey, maliciousConsumerContractAddress, assets.Ether(1).ToInt()) // Actually, PLI
	...
	_, err = linkContract.Transfer(sergey, proxyAddress, assets.Ether(500).ToInt()) // Actually, PLI
	require.NoError(t, err)
	backend.Commit()
	...
	_, err = linkContract.Transfer(sergey, revertingConsumerContractAddress, assets.Ether(500).ToInt()) // Actually, PLI
	...
	_, err = coordinatorContract.SetConfig(neil,
		...
		uint32(1),                              // 0.000001 PLI premium discount denominated in ETH
		uint8(10),                              // 10% native payment percentage
		uint8(5),                               // 5% PLI payment percentage
	)
...
func TestVRFV2PlusIntegration_ExternalOwnerConsumerExample(t *testing.T) {
	...
	require.NoError(t, err)
	backend.Commit()
	_, err = coordinator.SetPLIAndPLINativeFeed(owner, linkAddress, linkEthFeed)
	require.NoError(t, err)
	backend.Commit()
...
func TestVRFV2PlusIntegration_RequestCost(t *testing.T) {
	...
	t.Run("non-proxied consumer", func(tt *testing.T) {
		...
		tt.Log("gas estimate of non-proxied requestRandomWords with PLI payment:", linkEstimate)
