...
func TestValidateDB(t *testing.T) {
	...
	t.Run("dev url", func(t *testing.T) {
		t.Setenv(string(env.DatabaseURL), "postgres://postgres:admin@localhost:5432/plugin_dev_test?sslmode=disable")
	...
	t.Run("bad password url", func(t *testing.T) {
		t.Setenv(string(env.DatabaseURL), "postgres://postgres:pwdTooShort@localhost:5432/plugin_dev_prod?sslmode=disable")
