...
import (
	pluginconfig "github.com/goplugin/plugin-starknet/relayer/pkg/plugin/config"
	plugin "github.com/goplugin/pluginv3.0/v2/core/services/plugin"

	config "github.com/goplugin/pluginv3.0/v2/core/config"

	cosmosconfig "github.com/goplugin/plugin-cosmos/pkg/cosmos/config"

	mock "github.com/stretchr/testify/mock"

	solanaconfig "github.com/goplugin/plugin-solana/pkg/solana/config"

	time "time"

	toml "github.com/goplugin/pluginv3.0/v2/core/chains/evm/config/toml"
...
func (_m *GeneralConfig) AptosConfigs() plugin.RawConfigs {
	ret := _m.Called()
	...
	var r0 plugin.RawConfigs
	if rf, ok := ret.Get(0).(func() plugin.RawConfigs); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(plugin.RawConfigs)
		}
	}
...
func (_c *GeneralConfig_AptosConfigs_Call) Return(_a0 plugin.RawConfigs) *GeneralConfig_AptosConfigs_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GeneralConfig_AptosConfigs_Call) RunAndReturn(run func() plugin.RawConfigs) *GeneralConfig_AptosConfigs_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *GeneralConfig) StarknetConfigs() pluginconfig.TOMLConfigs {
	ret := _m.Called()
	...
	var r0 pluginconfig.TOMLConfigs
	if rf, ok := ret.Get(0).(func() pluginconfig.TOMLConfigs); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(pluginconfig.TOMLConfigs)
		}
	}
...
func (_c *GeneralConfig_StarknetConfigs_Call) Return(_a0 pluginconfig.TOMLConfigs) *GeneralConfig_StarknetConfigs_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *GeneralConfig_StarknetConfigs_Call) RunAndReturn(run func() pluginconfig.TOMLConfigs) *GeneralConfig_StarknetConfigs_Call {
	_c.Call.Return(run)
	return _c
}
