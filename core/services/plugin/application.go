...
// present at the configured root directory (default: ~/.plugin),
...
func (app *PluginApplication) SetLogLevel(lvl zapcore.Level) error {
...
func (app *PluginApplication) Start(ctx context.Context) error {
...
func (app *PluginApplication) StopIfStarted() error {
	app.startStopMu.Lock()
	defer app.startStopMu.Unlock()
	if app.started {
		return app.stop()
...
func (app *PluginApplication) Stop() error {
	app.startStopMu.Lock()
	defer app.startStopMu.Unlock()
	return app.stop()
}

func (app *PluginApplication) stop() (err error) {
	if !app.started {
...
func (app *PluginApplication) GetConfig() GeneralConfig {
	return app.Config
}

func (app *PluginApplication) GetKeyStore() keystore.Master {
	return app.KeyStore
}

func (app *PluginApplication) GetLogger() logger.SugaredLogger {
	return app.logger
}

func (app *PluginApplication) GetAuditLogger() audit.AuditLogger {
	return app.AuditLogger
}

func (app *PluginApplication) GetHealthChecker() services.Checker {
	return app.HealthChecker
}

func (app *PluginApplication) JobSpawner() job.Spawner {
	return app.jobSpawner
}

func (app *PluginApplication) JobORM() job.ORM {
	return app.jobORM
}

func (app *PluginApplication) BridgeORM() bridges.ORM {
	return app.bridgeORM
}

func (app *PluginApplication) BasicAdminUsersORM() sessions.BasicAdminUsersORM {
	return app.localAdminUsersORM
}

func (app *PluginApplication) AuthenticationProvider() sessions.AuthenticationProvider {
	return app.authenticationProvider
}

// TODO BCF-2516 remove this all together remove EVM specifics
func (app *PluginApplication) EVMORM() evmtypes.Configs {
	return app.GetRelayers().LegacyEVMChains().ChainNodeConfigs()
}

func (app *PluginApplication) PipelineORM() pipeline.ORM {
	return app.pipelineORM
}

func (app *PluginApplication) TxmStorageService() txmgr.EvmTxStore {
	return app.txmStorageService
}

func (app *PluginApplication) GetExternalInitiatorManager() webhook.ExternalInitiatorManager {
	return app.ExternalInitiatorManager
}

func (app *PluginApplication) SecretGenerator() SecretGenerator {
	return app.secretGenerator
}

// WakeSessionReaper wakes up the reaper to do its reaping.
func (app *PluginApplication) WakeSessionReaper() {
...
func (app *PluginApplication) RunJobV2(
	ctx context.Context,
	jobID int32,
...
func (app *PluginApplication) ResumeJobV2(
	ctx context.Context,
	taskID uuid.UUID,
...
func (app *PluginApplication) ReplayFromBlock(chainID *big.Int, number uint64, forceBroadcast bool) error {
...
func (app *PluginApplication) GetRelayers() RelayerChainInteroperators {
	return app.relayers
}
...
func (app *PluginApplication) GetWebAuthnConfiguration() sessions.WebAuthnConfiguration {
