...
func makeMinimalHTTPOracleSpec(t *testing.T, db *sqlx.DB, cfg plugin.GeneralConfig, contractAddress, transmitterAddress, keyBundle, fetchUrl, timeout string) *job.Job {
	var ocrSpec = job.OCROracleSpec{
...
func makeOCR2VRFJobSpec(t testing.TB, ks keystore.Master, cfg plugin.GeneralConfig,
