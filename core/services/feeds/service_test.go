...
import (
	...
	proto "github.com/goplugin/plugin-protos/orchestrator/feedsmanager"
	...
	jobmocks "github.com/goplugin/pluginv3.0/v2/core/services/job/mocks"
...
func setupTestServiceCfg(t *testing.T, overrideCfg func(c *plugin.Config, s *plugin.Secrets)) *TestService {
	t.Helper()
...
func Test_Service_RegisterManager_MultiFeedsManager(t *testing.T) {
	...
	svc := setupTestServiceCfg(t, func(c *plugin.Config, s *plugin.Secrets) {
...
func Test_Service_RevokeJob(t *testing.T) {
	...
	var (
		...
		defn = `
name = 'PLI / ETH | version 3 | contract 0x0000000000000000000000000000000000000000'
type               = "offchainreporting2"
pluginType         = "median"
schemaVersion      = 1
relay              = "evm"
...
observationSource  = """
// data source 1
ds1 [type=bridge name=\"bridge-api0\" requestData="{\\\"data\\": {\\\"from\\\":\\\"PLI\\\",\\\"to\\\":\\\"ETH\\\"}}"];
			...
			before: func(svc *TestService) {
				...
				svc.spawner.
					On("CreateJob",
						...
						mock.Anything,
						mock.MatchedBy(func(j *job.Job) bool {
							return j.Name.String == "PLI / ETH | version 3 | contract 0x0000000000000000000000000000000000000000"
						}),
					).
					Run(func(args mock.Arguments) { (args.Get(2).(*job.Job)).ID = 1 }).
					Return(nil)
