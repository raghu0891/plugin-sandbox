...
// other instances of the Plugin application.
//
// Plugin is designed to run as a single instance. Running multiple
// instances of Plugin on a single database at the same time is not
// supported and likely to lead to strange errors and possibly even data
// integrity failures.
//
// With that being said, a common use case is to run multiple Plugin
...
//
// Traditionally Plugin has used an advisory lock to manage this. However,
