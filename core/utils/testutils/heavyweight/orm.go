...
func FullTestDBV2(t testing.TB, overrideFn func(c *plugin.Config, s *plugin.Secrets)) (plugin.GeneralConfig, *sqlx.DB) {
	return KindFixtures.PrepareDB(t, overrideFn)
}

// FullTestDBNoFixturesV2 is the same as FullTestDB, but it does not load fixtures.
func FullTestDBNoFixturesV2(t testing.TB, overrideFn func(c *plugin.Config, s *plugin.Secrets)) (plugin.GeneralConfig, *sqlx.DB) {
	return KindTemplate.PrepareDB(t, overrideFn)
}

// FullTestDBEmptyV2 creates an empty DB (without migrations).
func FullTestDBEmptyV2(t testing.TB, overrideFn func(c *plugin.Config, s *plugin.Secrets)) (plugin.GeneralConfig, *sqlx.DB) {
...
func (c Kind) PrepareDB(t testing.TB, overrideFn func(c *plugin.Config, s *plugin.Secrets)) (plugin.GeneralConfig, *sqlx.DB) {
	testutils.SkipShort(t, "FullTestDB")

	gcfg := configtest.NewGeneralConfigSimulated(t, func(c *plugin.Config, s *plugin.Secrets) {
