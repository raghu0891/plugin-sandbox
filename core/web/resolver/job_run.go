...
func NewJobRun(run pipeline.Run, app plugin.Application) *JobRunResolver {
	return &JobRunResolver{run: run, app: app}
}

func NewJobRuns(runs []pipeline.Run, app plugin.Application) []*JobRunResolver {
...
func NewJobRunPayload(jr *pipeline.Run, app plugin.Application, err error) *JobRunPayloadResolver {
...
func NewJobRunsPayload(runs []pipeline.Run, total int32, app plugin.Application) *JobRunsPayloadResolver {
...
func NewRunJobPayload(run *pipeline.Run, app plugin.Application, err error) *RunJobPayloadResolver {
...
func NewRunJobSuccess(run pipeline.Run, app plugin.Application) *RunJobSuccessResolver {
