...
func NewJob(app plugin.Application, j job.Job) *JobResolver {
	return &JobResolver{app: app, j: j}
}

func NewJobs(app plugin.Application, jobs []job.Job) []*JobResolver {
...
func NewJobsPayload(app plugin.Application, jobs []job.Job, total int32) *JobsPayloadResolver {
...
func NewJobPayload(app plugin.Application, j *job.Job, err error) *JobPayloadResolver {
...
func NewCreateJobPayload(app plugin.Application, job *job.Job, inputErrs map[string]string) *CreateJobPayloadResolver {
...
func NewCreateJobSuccess(app plugin.Application, job *job.Job) *CreateJobSuccessResolver {
...
func NewDeleteJobPayload(app plugin.Application, j *job.Job, err error) *DeleteJobPayloadResolver {
...
func NewDeleteJobSuccess(app plugin.Application, job *job.Job) *DeleteJobSuccessResolver {
