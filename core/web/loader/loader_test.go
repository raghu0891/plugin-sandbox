...
import (
	...
	testutils2 "github.com/goplugin/pluginv3.0/v2/core/web/testutils"
)
...
func TestLoader_Chains(t *testing.T) {
	...
	app.On("GetRelayers").Return(&pluginmocks.FakeRelayerChainInteroperators{Relayers: map[commontypes.RelayID]loop.Relayer{
		commontypes.RelayID{
...
func TestLoader_Nodes(t *testing.T) {
	...
	rcInterops := &pluginmocks.FakeRelayerChainInteroperators{Nodes: []commontypes.NodeStatus{
