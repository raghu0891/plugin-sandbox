...
func New(app plugin.Application) *Dataloader {
	var (
...
func Middleware(app plugin.Application) gin.HandlerFunc {
...
func InjectDataloader(ctx context.Context, app plugin.Application) context.Context {
