...
import (
	...
	commontxmgr "github.com/goplugin/pluginv3.0/v2/common/txmgr"
...
// EVMTransfersController can send PLI tokens to another address
type EVMTransfersController struct {
	App plugin.Application
}

// Create sends ETH from the Plugin's account to a specified address.
//
