...
func TestTokenAuthRequired_TokenCredentials(t *testing.T) {
	...
	request.Header.Set("X-Plugin-EA-AccessKey", eia.AccessKey)
	request.Header.Set("X-Plugin-EA-Secret", eia.Secret)
...
func TestTokenAuthRequired_BadTokenCredentials(t *testing.T) {
	...
	request.Header.Set("Content-Type", web.MediaType)
	request.Header.Set("X-Plugin-EA-AccessKey", eia.AccessKey)
	request.Header.Set("X-Plugin-EA-Secret", "every unpleasant commercial color from aquamarine to beige")
