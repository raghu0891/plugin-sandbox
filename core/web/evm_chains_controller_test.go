...
func Test_EVMChainsController_Show(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			controller := setupEVMChainsControllerTest(t, configtest.NewGeneralConfig(t, func(c *plugin.Config, s *plugin.Secrets) {
				if tc.want != nil {
...
func setupEVMChainsControllerTest(t *testing.T, cfg plugin.GeneralConfig) *TestEVMChainsController {
