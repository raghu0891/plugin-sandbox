...
func setupEVMForwardersControllerTest(t *testing.T, overrideFn func(c *plugin.Config, s *plugin.Secrets)) *TestEVMForwardersController {
...
func Test_EVMForwardersController_Track(t *testing.T) {
	...
	controller := setupEVMForwardersControllerTest(t, func(c *plugin.Config, s *plugin.Secrets) {
