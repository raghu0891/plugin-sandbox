...
import (
	...
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/ccip/generated/ccip_reader_tester"
	...
	readermocks "github.com/goplugin/plugin-ccip/mocks/pkg/contractreader"
...
func TestCCIPReader_CommitReportsGTETimestamp(t *testing.T) {
	...
	// TODO assert once plugin-ccip changes are done
