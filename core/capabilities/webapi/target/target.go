...
var capabilityInfo = capabilities.MustNewCapabilityInfo(
	...
	"A target that sends HTTP requests to external clients via the Plugin Gateway.",
)
...
// Capability is a target capability that sends HTTP requests to external clients via the Plugin Gateway.
