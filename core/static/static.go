...
func SetConsumerName(uri *url.URL, name string, id *uuid.UUID) {
	...
	applicationName := fmt.Sprintf("Plugin%s|%s", buildPrettyVersion(), name)
	if id != nil {
