...
func (_m *RPCClient) PLIBalance(ctx context.Context, accountAddress common.Address, linkAddress common.Address) (*assets.Link, error) {
...
// RPCClient_PLIBalance_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PLIBalance'
type RPCClient_PLIBalance_Call struct {
	*mock.Call
}
...
func (_e *RPCClient_Expecter) PLIBalance(ctx interface{}, accountAddress interface{}, linkAddress interface{}) *RPCClient_PLIBalance_Call {
	return &RPCClient_PLIBalance_Call{Call: _e.mock.On("PLIBalance", ctx, accountAddress, linkAddress)}
}

func (_c *RPCClient_PLIBalance_Call) Run(run func(ctx context.Context, accountAddress common.Address, linkAddress common.Address)) *RPCClient_PLIBalance_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RPCClient_PLIBalance_Call) Return(_a0 *assets.Link, _a1 error) *RPCClient_PLIBalance_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RPCClient_PLIBalance_Call) RunAndReturn(run func(context.Context, common.Address, common.Address) (*assets.Link, error)) *RPCClient_PLIBalance_Call {
	_c.Call.Return(run)
	return _c
}
