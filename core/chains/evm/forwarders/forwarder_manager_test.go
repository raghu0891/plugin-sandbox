...
import (
	...
	"github.com/goplugin/plugin-libocr/gethwrappers2/testocr2aggregator"
...
var SimpleOracleCallABI = evmtypes.MustGetABI(operator_wrapper.OperatorABI).Methods["getPluginToken"]
...
func TestFwdMgr_MaybeForwardTransaction(t *testing.T) {
	...
	ht := headtracker.NewSimulatedHeadTracker(evmClient, lpOpts.UseFinalityTag, lpOpts.FinalityDepth)
