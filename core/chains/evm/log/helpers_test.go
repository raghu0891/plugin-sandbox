...
func newBroadcasterHelper(t *testing.T, blockHeight int64, timesSubscribe int, filterLogsResult []types.Log, overridesFn func(*plugin.Config, *plugin.Secrets)) *broadcasterHelper {
...
func newBroadcasterHelperWithEthClient(t *testing.T, ethClient evmclient.Client, highestSeenHead *evmtypes.Head, overridesFn func(*plugin.Config, *plugin.Secrets)) *broadcasterHelper {
	globalConfig := configtest.NewGeneralConfig(t, func(c *plugin.Config, s *plugin.Secrets) {
