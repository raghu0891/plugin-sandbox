...
import (
	...
	assets "github.com/goplugin/pluginv3.0/v2/core/chains/evm/assets"
	...
	rollups "github.com/goplugin/pluginv3.0/v2/core/chains/evm/gas/rollups"

	types "github.com/goplugin/pluginv3.0/v2/common/fee/types"
)
...
func (_c *EvmEstimator_GetLegacyGas_Call) RunAndReturn(run func(context.Context, []byte, uint64, *assets.Wei, ...types.Opt) (*assets.Wei, uint64, error)) *EvmEstimator_GetLegacyGas_Call {
	_c.Call.Return(run)
	return _c
}
