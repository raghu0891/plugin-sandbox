...
type Config struct {
	...
	LinkTokenAddr        string   `mapstructure:"PLI_TOKEN_ADDR"`
	...
	FundNodeAmount       string   `mapstructure:"FUND_PLUGIN_NODE"`
	PluginDockerImage string   `mapstructure:"PLUGIN_DOCKER_IMAGE"`
	...
	FallbackLinkPrice      int64  `mapstructure:"FALLBACK_PLI_PRICE"`
...
func init() {
	viper.SetDefault("APPROVE_AMOUNT", "100000000000000000000000") // 1000 PLI
	viper.SetDefault("GAS_LIMIT", 8000000)
	viper.SetDefault("PAYMENT_PREMIUM_PBB", 200000000)
	viper.SetDefault("FLAT_FEE_MICRO_PLI", 0)
	...
	viper.SetDefault("FALLBACK_PLI_PRICE", 20000000000000000)
	viper.SetDefault("PLUGIN_DOCKER_IMAGE", "smartcontract/plugin:1.13.0-root")
	viper.SetDefault("POSTGRES_DOCKER_IMAGE", "postgres:latest")

	viper.SetDefault("UPKEEP_ADD_FUNDS_AMOUNT", "100000000000000000000") // 100 PLI
	...
	viper.SetDefault("FUND_PLUGIN_NODE", "20000000000000000000")
}
