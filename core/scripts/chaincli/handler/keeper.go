...
import (
	...
	registrylogic20 "github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/keeper_registry_logic2_0"
	...
	upkeep "github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/upkeep_perform_counter_restrictive_wrapper"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/verifiable_load_streams_lookup_upkeep_wrapper"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/verifiable_load_upkeep_wrapper"
...
func (k *Keeper) DeployKeepers(ctx context.Context) {
	...
	for i, keeperAddr := range k.cfg.Keepers {
		...
		if len(email) == 0 {
			email = defaultPluginNodeLogin
		}
		pwd := k.cfg.KeeperPasswords[i]
		if len(pwd) == 0 {
			pwd = defaultPluginNodePassword
		}
