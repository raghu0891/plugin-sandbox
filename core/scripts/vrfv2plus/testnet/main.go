...
import (
	...
	"github.com/goplugin/pluginv3.0/core/scripts/vrfv2plus/testnet/v2plusscripts"

	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/chain_specific_util_helper"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_coordinator_v2_5"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_coordinator_v2_5_optimism"
	...
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_load_test_external_sub_owner"
	...
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrfv2plus_wrapper_consumer_example"
...
func main() {
	...
	case "manual-fulfill":
		...
		// plugin node logs for the VRF v2 request ID in hex. You will find a log for
	...
	case "coordinator-set-config":
		...
		flatFeeLinkDiscountPPM := cmd.Int64("flat-fee-link-discount-ppm", 100, "fulfillment flat fee discount for PLI payment denominated in native ppm")
		nativePremiumPercentage := cmd.Int64("native-premium-percentage", 1, "premium percentage for native payment")
		linkPremiumPercentage := cmd.Int64("link-premium-percentage", 1, "premium percentage for PLI payment")
	...
	case "consumer-cancel":
		...
		helpers.ConfirmTXMined(context.Background(), e.Ec, tx, e.ChainID)
	case "consumer-topup":
		// NOTE NEED TO FUND CONSUMER WITH PLI FIRST
	...
	case "coordinator-withdrawable-tokens":
		...
		start := withdrawableTokensCmd.Int("start-link", 10_000, "the starting amount of PLI to check")
