...
import (
	...
	linktoken "github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/link_token_interface"
	"github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/solidity_vrf_coordinator_interface"
	vrfltoc "github.com/goplugin/pluginv3.0/v2/core/gethwrappers/generated/vrf_load_test_ownerless_consumer"
...
func main() {
	...
	case "coordinator-deploy":
		...
		linkAddress := cmd.String("link-address", "", "PLI token contract address")
	...
	case "coordinator-register-key":
		...
		jobID := cmd.String("job-id", "", "Job UUID on the plugin node (UUID)")
	...
	case "ownerless-consumer-request":
		...
		paymentStr := cmd.String("payment", "" /* 0.1 PLI */, "the payment amount in PLI")
